...
public:
  ...
  template <class ParamType> default_type precompute(ParamType &parameters) {
    ...
    loop.run(CCNoGradientPrecomputeFunctor<decltype(parameters.transformation),
                                           ...
                                           Im2MaskInterpolatorType>(parameters.transformation,
...
private:
  ...
  template <typename LinearTrafoType,
            typename ImageType1,
            typename ImageType2,
  ...
  struct CCNoGradientPrecomputeFunctor {
    CCNoGradientPrecomputeFunctor(const LinearTrafoType &transformation,
                                  ImageType1 &im1,
                                  ImageType2 &im2,
