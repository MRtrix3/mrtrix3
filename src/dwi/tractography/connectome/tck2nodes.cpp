...
node_t Tck2nodes_end_voxels::select_node (const Tractography::Streamline<float>& tck, VoxelType& voxel, const bool end) const
{
...
node_t Tck2nodes_radial::select_node (const Tractography::Streamline<float>& tck, VoxelType& voxel, const bool end) const
{
...
node_t Tck2nodes_revsearch::select_node (const Tractography::Streamline<float>& tck, VoxelType& voxel, const bool end) const
{
...
node_t Tck2nodes_forwardsearch::select_node (const Tractography::Streamline<float>& tck, VoxelType& voxel, const bool end) const
{
