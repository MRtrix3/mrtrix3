...
LineSearchFunctor::Result LineSearchFunctor::get(const double dFs) const {
...
LineSearchFunctor::Fixel::Fixel(const SIFT::Track_fixel_contribution &in,
                                const TckFactor &tckfactor,
                                const double Fs,
                                const double fixel_coeff_mean)
