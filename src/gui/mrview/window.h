    ...
    namespace MRView
    {
      ...
      { MEMALIGN(Window)
        ...
        private:
          ...
          ColourMapper::Position colourbar_position, tools_colourbar_position;
          ...
          static ColourMapper::Position parse_colourmap_position_str (const std::string& position_str);
