...
void Window::hide_negative_lobes_slot(bool is_checked) { render_frame->set_hide_neg_values(is_checked); }

void Window::colour_by_direction_slot(bool is_checked) { render_frame->set_color_by_dir(is_checked); }

void Window::reset_scale_slot() { render_frame->reset_scale(); }

void Window::reset_view_slot() { render_frame->reset_view(); }
