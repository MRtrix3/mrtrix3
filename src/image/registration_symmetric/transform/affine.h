...
#ifndef __image_registration_symmetric_transform_affine_h__
#define __image_registration_symmetric_transform_affine_h__
        ...
        class Affine : public Base<ValueType>  {
          public:
            ...
            Affine () : Base<ValueType> (12) {
              ...
              DEBUG("symmetric affine transformation");
            }
