...
#ifndef __image_registration_symmetric_transform_rigid_h__
#define __image_registration_symmetric_transform_rigid_h__

#include "image/registration_symmetric/transform/base.h"
          ...
          public:
            ...
            inline bool operator() (Math::Vector<ValueType>& newx,
              ...
              for (size_t n = 0; n < x.size(); ++n) {
                if (fabs(newx[n] - x[n]) > std::numeric_limits<ValueType>::epsilon())
                  changed = true;
              }
              return changed;
            }
