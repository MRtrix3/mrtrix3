...
mrcheckerboardmask_input_spec = specs.SpecInfo(
    name="mrcheckerboardmask_input", fields=input_fields, bases=(specs.ShellSpec,)
)
...
mrcheckerboardmask_output_spec = specs.SpecInfo(
    name="mrcheckerboardmask_output", fields=output_fields, bases=(specs.ShellOutSpec,)
)
...
class mrcheckerboardmask(ShellCommandTask):
    ...
    input_spec = mrcheckerboardmask_input_spec
    output_spec = mrcheckerboardmask_output_spec
