...
input_fields = [
    ...
    (
        ...
        str,
        {
            "argstr": "",
            "position": 0,
            "help_string": """the input connectome.""",
            "mandatory": True,
        },
    ),
    (
        ...
        str,
        {
            "argstr": "",
            "position": 1,
            "help_string": """the operation to apply, one of: to_symmetric, upper_triangular, lower_triangular, transpose, zero_diagonal.""",
            "mandatory": True,
            "allowed_values": [
                "to_symmetric",
                "to_symmetric",
    ...
    (
        ...
        str,
        {
            "argstr": "",
            "position": 2,
            "help_string": """the output connectome.""",
            "mandatory": True,
        },
    ),
    # Standard options
