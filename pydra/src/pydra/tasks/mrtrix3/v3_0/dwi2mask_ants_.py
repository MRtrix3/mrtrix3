...
dwi2mask_ants_input_spec = specs.SpecInfo(
    name="dwi2mask_ants_input", fields=input_fields, bases=(specs.ShellSpec,)
)

output_fields = [
    ("output", FsObject, {"help_string": "The output mask image", "mandatory": True})
]
dwi2mask_ants_output_spec = specs.SpecInfo(
    name="dwi2mask_ants_output", fields=output_fields, bases=(specs.ShellOutSpec,)
)
...
class dwi2mask_ants(ShellCommandTask):
    ...
    input_spec = dwi2mask_ants_input_spec
    output_spec = dwi2mask_ants_output_spec
