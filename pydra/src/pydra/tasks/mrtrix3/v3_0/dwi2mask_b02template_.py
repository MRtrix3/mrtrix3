...
input_fields = [
    ...
    (
        ...
        typing.Any,
        {
            "help_string": "Command-line options to pass to the FSL flirt command (provide a string within quotation marks that contains at least one space, even if only passing a single command-line option to flirt)",
    ...
    (
        ...
        typing.Any,
        {
            "help_string": "Specify a FNIRT configuration file for registration",
            "argstr": "-fnirt_config",
        },
    ),
    (
        ...
        typing.Any,
        {
            "help_string": "Provide options to be passed to the ANTs registration command (see Description)",
            "argstr": "-ants_options",
        },
    ),
    (
        ...
        typing.Any,
        {
            "help_string": "The software to use for template registration; options are: antsfull,antsquick,fsl; default is antsquick",
    ...
    (
        ...
        typing.Any,
        {
            "help_string": "Provide the template image to which the input data will be registered, and the mask to be projected to the input image. The template image should be T2-weighted.",
            "argstr": "-template",
        },
    ),
    (
...
dwi2mask_b02template_input_spec = specs.SpecInfo(
    name="dwi2mask_b02template_input", fields=input_fields, bases=(specs.ShellSpec,)
)

output_fields = [
    ("output", FsObject, {"help_string": "The output mask image", "mandatory": True})
]
dwi2mask_b02template_output_spec = specs.SpecInfo(
    name="dwi2mask_b02template_output",
    fields=output_fields,
    bases=(specs.ShellOutSpec,),
)


class dwi2mask_b02template(ShellCommandTask):
    """
            References
        ----------
    ...
    input_spec = dwi2mask_b02template_input_spec
    output_spec = dwi2mask_b02template_output_spec
