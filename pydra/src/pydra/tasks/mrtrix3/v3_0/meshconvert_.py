...
input_fields = [
    ...
    (
        ...
        {
            "argstr": "-binary",
            "help_string": """write the output mesh file in binary format (if supported)""",
        },
    ),
    (
        "transform",
        ...
        {
            "argstr": "-transform",
            "help_string": """transform vertices from one coordinate space to another, based on a template image; options are: first2real, real2first, voxel2real, real2voxel, fs2real""",
        },
    ),
    # Standard options
    (
