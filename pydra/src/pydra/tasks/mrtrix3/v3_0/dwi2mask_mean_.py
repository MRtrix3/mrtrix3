...
input_fields = [
    ...
    (
        ...
        typing.Any,
        {
            "help_string": "Comma separated list of shells to be included in the volume averaging",
            "argstr": "-shells",
        },
    ),
    (
...
dwi2mask_mean_input_spec = specs.SpecInfo(
    name="dwi2mask_mean_input", fields=input_fields, bases=(specs.ShellSpec,)
)

output_fields = [
    ("output", FsObject, {"help_string": "The output mask image", "mandatory": True})
]
dwi2mask_mean_output_spec = specs.SpecInfo(
    name="dwi2mask_mean_output", fields=output_fields, bases=(specs.ShellOutSpec,)
)


class dwi2mask_mean(ShellCommandTask):
    """
            References
        ----------
    ...
    input_spec = dwi2mask_mean_input_spec
    output_spec = dwi2mask_mean_output_spec
    executable = ("dwi2mask", "mean")
