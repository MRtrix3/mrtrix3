...
input_fields = [
    ...
    (
        ...
        specs.MultiInputObj[ImageIn],
        {
            "argstr": "",
            "position": 0,
            "help_string": """the 5TT image(s) to be tested""",
            "mandatory": True,
        },
    ),
    (
        ...
        {
            "argstr": "-voxels",
            "help_string": """output mask images highlighting voxels where the input does not conform to 5TT requirements""",
        },
    ),
    # Standard options
    (
