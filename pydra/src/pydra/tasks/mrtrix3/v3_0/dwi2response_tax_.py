...
input_fields = [
    ...
    (
        ...
        float,
        {
            "help_string": "Second-to-first-peak amplitude ratio threshold",
            "argstr": "-peak_ratio",
        },
    ),
    (
    ...
    (
        ...
        float,
        {
            "help_string": "Percentile change in any RF coefficient required to continue iterating",
            "argstr": "-convergence",
        },
    ),
    (
...
dwi2response_tax_input_spec = specs.SpecInfo(
    name="dwi2response_tax_input", fields=input_fields, bases=(specs.ShellSpec,)
)
...
dwi2response_tax_output_spec = specs.SpecInfo(
    name="dwi2response_tax_output", fields=output_fields, bases=(specs.ShellOutSpec,)
)


class dwi2response_tax(ShellCommandTask):
    """
            References
        ----------
    ...
    input_spec = dwi2response_tax_input_spec
    output_spec = dwi2response_tax_output_spec
