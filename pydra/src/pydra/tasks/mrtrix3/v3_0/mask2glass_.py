...
input_fields = [
    (
        ...
        FsObject,
        {
            "help_string": "The input mask image",
            "mandatory": True,
            "position": 0,
            "argstr": "",
        },
    ...
    (
        ...
        Path,
        {
            "help_string": "The output glass brain image",
            "position": 1,
            "argstr": "",
    ...
    (
        ...
        int,
        {
            "help_string": "Provide number of passes for dilation step; default = 2",
            "argstr": "-dilate",
        },
    ),
    (
        ...
        float,
        {
            "help_string": "Provide resolution upscaling value; default = 2.0",
            "argstr": "-scale",
        },
    ),
    (
        ...
        float,
        {
            "help_string": "Provide standard deviation of smoothing (in mm); default = 1.0",
            "argstr": "-smooth",
        },
    ),
]
mask2glass_input_spec = specs.SpecInfo(
    name="mask2glass_input", fields=input_fields, bases=(specs.ShellSpec,)
)
...
output_fields = [
    (
        "output",
        FsObject,
        {"help_string": "The output glass brain image", "mandatory": True},
    )
]
mask2glass_output_spec = specs.SpecInfo(
    name="mask2glass_output", fields=output_fields, bases=(specs.ShellOutSpec,)
)


class mask2glass(ShellCommandTask):
    """
            References
        ----------
    ...
    input_spec = mask2glass_input_spec
    output_spec = mask2glass_output_spec
    executable = "mask2glass"
