...
input_fields = [
    ...
    (
        ...
        typing.Any,
        {
            "help_string": "Provide an initial brain mask, which will constrain the response function estimation (if omitted, the default dwi2mask algorithm will be used)",
            "argstr": "-init_mask",
        },
    ),
    (
    ...
    (
        ...
        float,
        {
            "help_string": "the threshold on the total tissue density sum image used to derive the brain mask; default is 0.5",
            "argstr": "-threshold",
        },
    ),
    (
        ...
        typing.Any,
        {
            "help_string": "Export the tissue sum image that was used to generate the mask",
            "argstr": "-tissuesum",
        },
    ),
    (
...
dwi2mask_mtnorm_input_spec = specs.SpecInfo(
    name="dwi2mask_mtnorm_input", fields=input_fields, bases=(specs.ShellSpec,)
)

output_fields = [
    ("output", FsObject, {"help_string": "The output mask image", "mandatory": True})
]
dwi2mask_mtnorm_output_spec = specs.SpecInfo(
    name="dwi2mask_mtnorm_output", fields=output_fields, bases=(specs.ShellOutSpec,)
)


class dwi2mask_mtnorm(ShellCommandTask):
    """
            References
        ----------
    ...
    input_spec = dwi2mask_mtnorm_input_spec
    output_spec = dwi2mask_mtnorm_output_spec
