...
input_fields = [
    ...
    (
        "stripped",
        typing.Any,
        {"help_string": "The output stripped image", "argstr": "-stripped"},
    ),
    ("gpu", bool, {"help_string": "Use the GPU", "argstr": "-gpu"}),
    (
        "model",
        typing.Any,
        {"help_string": "Alternative model weights", "argstr": "-model"},
    ),
    (
        "nocsf",
        bool,
...
dwi2mask_synthstrip_input_spec = specs.SpecInfo(
    name="dwi2mask_synthstrip_input", fields=input_fields, bases=(specs.ShellSpec,)
)

output_fields = [
    ("output", FsObject, {"help_string": "The output mask image", "mandatory": True})
]
dwi2mask_synthstrip_output_spec = specs.SpecInfo(
    name="dwi2mask_synthstrip_output", fields=output_fields, bases=(specs.ShellOutSpec,)
)
...
class dwi2mask_synthstrip(ShellCommandTask):
    ...
    input_spec = dwi2mask_synthstrip_input_spec
    output_spec = dwi2mask_synthstrip_output_spec
