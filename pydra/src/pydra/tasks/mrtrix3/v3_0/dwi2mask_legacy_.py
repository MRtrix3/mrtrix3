...
dwi2mask_legacy_input_spec = specs.SpecInfo(
    name="dwi2mask_legacy_input", fields=input_fields, bases=(specs.ShellSpec,)
)

output_fields = [
    ("output", FsObject, {"help_string": "The output mask image", "mandatory": True})
]
dwi2mask_legacy_output_spec = specs.SpecInfo(
    name="dwi2mask_legacy_output", fields=output_fields, bases=(specs.ShellOutSpec,)
)


class dwi2mask_legacy(ShellCommandTask):
    """
            References
        ----------
    ...
    input_spec = dwi2mask_legacy_input_spec
    output_spec = dwi2mask_legacy_output_spec
    executable = ("dwi2mask", "legacy")
