...
input_fields = [
    (
        ...
        typing.Any,
        {
            "help_string": "Path from which to commence filesystem search",
            "mandatory": True,
            "position": 0,
            "argstr": "",
        },
    ...
    (
        ...
        bool,
        {
            "help_string": "Run script in test mode: will list identified files / directories, but not attempt to delete them",
            "argstr": "-test",
        },
    ),
    (
        ...
        typing.Any,
        {
            "help_string": "Write list of items that the script failed to delete to a text file",
            "argstr": "-failed",
        },
    ),
]
mrtrix_cleanup_input_spec = specs.SpecInfo(
    name="mrtrix_cleanup_input", fields=input_fields, bases=(specs.ShellSpec,)
)

output_fields = []
mrtrix_cleanup_output_spec = specs.SpecInfo(
    name="mrtrix_cleanup_output", fields=output_fields, bases=(specs.ShellOutSpec,)
)


class mrtrix_cleanup(ShellCommandTask):
    """
            References
        ----------
    ...
    input_spec = mrtrix_cleanup_input_spec
    output_spec = mrtrix_cleanup_output_spec
