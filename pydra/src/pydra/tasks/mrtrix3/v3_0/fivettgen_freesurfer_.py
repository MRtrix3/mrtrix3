...
input_fields = [
    (
        ...
        FsObject,
        {
            "help_string": "The input FreeSurfer parcellation image (any image containing 'aseg' in its name)",
            "mandatory": True,
            "position": 0,
            "argstr": "",
        },
    ...
    (
        ...
        typing.Any,
        {
            "help_string": "Manually provide path to the lookup table on which the input parcellation image is based (e.g. FreeSurferColorLUT.txt)",
            "argstr": "-lut",
        },
    ),
    (
...
fivettgen_freesurfer_input_spec = specs.SpecInfo(
    name="fivettgen_freesurfer_input", fields=input_fields, bases=(specs.ShellSpec,)
)

output_fields = [
    ("output", FsObject, {"help_string": "The output 5TT image", "mandatory": True})
]
fivettgen_freesurfer_output_spec = specs.SpecInfo(
    name="fivettgen_freesurfer_output",
    fields=output_fields,
    bases=(specs.ShellOutSpec,),
)


class fivettgen_freesurfer(ShellCommandTask):
    """
            References
        ----------
    ...
    input_spec = fivettgen_freesurfer_input_spec
    output_spec = fivettgen_freesurfer_output_spec
