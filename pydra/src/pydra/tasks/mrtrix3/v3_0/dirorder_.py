...
dirorder_input_spec = specs.SpecInfo(
    name="dirorder_input", fields=input_fields, bases=(specs.ShellSpec,)
)
...
dirorder_output_spec = specs.SpecInfo(
    name="dirorder_output", fields=output_fields, bases=(specs.ShellOutSpec,)
)
...
class dirorder(ShellCommandTask):
    ...
    executable = "dirorder"
    input_spec = dirorder_input_spec
    output_spec = dirorder_output_spec
