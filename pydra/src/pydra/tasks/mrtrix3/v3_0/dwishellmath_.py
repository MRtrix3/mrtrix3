...
dwishellmath_input_spec = specs.SpecInfo(
    name="dwishellmath_input", fields=input_fields, bases=(specs.ShellSpec,)
)

output_fields = [
    ("output", FsObject, {"help_string": "The output image series", "mandatory": True})
]
dwishellmath_output_spec = specs.SpecInfo(
    name="dwishellmath_output", fields=output_fields, bases=(specs.ShellOutSpec,)
)
...
class dwishellmath(ShellCommandTask):
    ...
    input_spec = dwishellmath_input_spec
    output_spec = dwishellmath_output_spec
