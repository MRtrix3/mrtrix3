...
input_fields = [
    ...
    (
        ...
        File,
        {
            "argstr": "",
            "position": 0,
            "help_string": """a text file containing the file names of the input images, one file per line""",
            "mandatory": True,
        },
    ),
    (
    ...
    (
        ...
        ImageIn,
        {
            "argstr": "",
            "position": 3,
            "help_string": """a mask used to define voxels included in the analysis.""",
            "mandatory": True,
        },
    ),
    (
    ...
    (
        ...
        {
            "argstr": "-tfce_e",
            "help_string": """tfce extent exponent (default: 0.5)""",
        },
    ),
    (
        "tfce_h",
        ...
        {
            "argstr": "-tfce_h",
            "help_string": """tfce height exponent (default: 2)""",
        },
    ),
    ...
    (
        ...
        {
            "argstr": "-column",
            "help_string": """add a column to the design matrix corresponding to subject voxel-wise values (note that the contrast matrix must include an additional column for each use of this option); the text file provided via this option should contain a file name for each subject""",
        },
    ),
    # Additional options for mrclusterstats Option Group
    (
        "threshold",
        float,
        {
            "argstr": "-threshold",
            "help_string": """the cluster-forming threshold to use for a standard cluster-based analysis. This disables TFCE, which is the default otherwise.""",
        },
    ),
    (
        "connectivity",
