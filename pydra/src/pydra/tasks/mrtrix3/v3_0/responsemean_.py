...
input_fields = [
    (
        ...
        typing.Any,
        {
            "help_string": "The input response functions",
            "mandatory": True,
            "position": 0,
            "argstr": "",
        },
    ...
    (
        ...
        Path,
        {
            "help_string": "The output mean response function",
            "mandatory": True,
            "position": 1,
            "argstr": "",
        },
...
responsemean_input_spec = specs.SpecInfo(
    name="responsemean_input", fields=input_fields, bases=(specs.ShellSpec,)
)
...
output_fields = [
    (
        "output",
        FsObject,
        {"help_string": "The output mean response function", "mandatory": True},
    )
]
responsemean_output_spec = specs.SpecInfo(
    name="responsemean_output", fields=output_fields, bases=(specs.ShellOutSpec,)
)
...
class responsemean(ShellCommandTask):
    ...
    input_spec = responsemean_input_spec
    output_spec = responsemean_output_spec
