...
set(BINPATH_CONTENTS
    ...
    # Project version module passed to mrtrix3.app so a Python command reports its OWN project version
    # (set in external-project mode below); None for core MRtrix3 commands.
    "_project = None\n"
)
...
if(DEFINED EXTERNAL_COMMANDS)
    ...
    string(APPEND BINPATH_CONTENTS
        ...
        # The project's own version module (VERSION / BUILD_DATE), generated by the project's build
        # system alongside its package. Handed to _execute() so mrtrix3.app reports the PROJECT
        # version for this Python command - the parallel of the C++ commands' set_project_version().
        "from ${PACKAGE} import version as _project\n"
        "\n"
    )
else()
    string(APPEND BINPATH_CONTENTS
...
string(APPEND BINPATH_CONTENTS
    "_execute(module.usage, module.execute, project=_project)\n"
)
