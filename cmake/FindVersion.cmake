...
if(EXISTS ${ROOT_DIR}/.git)
    if(GIT_EXECUTABLE)
        ...
        if(NOT MRTRIX_GIT_TAG_ERROR AND NOT MRTRIX_GIT_COMMIT_ERROR)
            ...
            if(MRTRIX_IGNORE_VERSION_MISMATCH OR DEFINED ENV{MRTRIX_IGNORE_VERSION_MISMATCH})
                message(STATUS "MRTRIX_IGNORE_VERSION_MISMATCH is set; ignoring version mismatch between git tag and MRtrix base version.")
            else()
