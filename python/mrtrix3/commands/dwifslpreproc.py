...
import glob, itertools, json, os, shlex, shutil, sys
...
def execute(): #pylint: disable=unused-variable
  ...
  if topup_files_userpath:
    ...
    if os.path.isfile(topup_files_userpath):
      ...
      except app.Parser.ArgumentError as exc:
        raise app.Parser.ArgumentError(f'Unable to find topup files from user specification "{topup_files_userpath}"') from exc
