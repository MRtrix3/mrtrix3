...
ppi <- 800
png("/home/dave/Gdrive/Documents/JournalPapers/CFE/Figures/Invivo/AUC_heat_effect1_smooth10.png", width=7*ppi, height=6*ppi, res = ppi)
...
#      + scale_fill_gradientn(colours=c("black","blue","cyan","yellow","red"), breaks=seq(0,.8,by=0.2)) 
      + scale_fill_gradientn(colours=c("#352a87","#3340b3","#0c5dde","#066fdf","#127cd7","#118ad2","#069ccf","#06a7c3","#15b0b4","#33b8a0","#5abd8a","#80bf79","#a5be6a","#c4bb5d","#e2b951","#fabb40","#fbce2d","#f4e11e","#f8fa0d"), breaks=seq(0,.2,by=0.1)) 
