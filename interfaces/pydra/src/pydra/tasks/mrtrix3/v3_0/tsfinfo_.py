...
input_fields = [
    ...
    (
        ...
        {
            "argstr": "-count",
            "help_string": """count number of tracks in file explicitly, ignoring the header""",
        },
    ),
    (
        "ascii",
        ...
        {
            "argstr": "-ascii",
            "help_string": """save values of each track scalar file in individual ascii files, with the specified prefix.""",
        },
    ),
    # Standard options
    (
