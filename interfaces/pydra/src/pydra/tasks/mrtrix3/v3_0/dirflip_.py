...
input_fields = [
    ...
    (
        ...
        File,
        {
            "argstr": "",
            "position": 0,
            "help_string": """the input files for the directions.""",
            "mandatory": True,
        },
    ),
    (
        ...
        Path,
        {
            ...
            "help_string": """the output files for the directions.""",
        },
    ),
    (
        "permutations",
        ...
        {
            "argstr": "-permutations",
            "help_string": """number of permutations to try (default: 100000000)""",
        },
    ),
    (
        "cartesian",
