...
input_fields = [
    ...
    (
        ...
        ImageIn,
        {
            "argstr": "",
            "position": 0,
            "help_string": """the input template image.""",
            "mandatory": True,
        },
    ),
    (
...
warpinit_input_spec = specs.SpecInfo(
    name="warpinit_input", fields=input_fields, bases=(specs.ShellSpec,)
)
...
warpinit_output_spec = specs.SpecInfo(
    name="warpinit_output", fields=output_fields, bases=(specs.ShellOutSpec,)
)


class warpinit(ShellCommandTask):
    ...
    executable = "warpinit"
    input_spec = warpinit_input_spec
    output_spec = warpinit_output_spec
