...
dwi2adc_input_spec = specs.SpecInfo(
    name="dwi2adc_input", fields=input_fields, bases=(specs.ShellSpec,)
)
...
dwi2adc_output_spec = specs.SpecInfo(
    name="dwi2adc_output", fields=output_fields, bases=(specs.ShellOutSpec,)
)
...
class dwi2adc(ShellCommandTask):
    ...
    executable = "dwi2adc"
    input_spec = dwi2adc_input_spec
    output_spec = dwi2adc_output_spec
