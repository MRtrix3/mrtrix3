      ...
      namespace GT {
        ...
        public:
          ...
          protected:
            ...
            Math::Matrix<double> K, A;
            
            friend class ExternalEnergyComputer;
          };
          
          
          ExternalEnergyComputer(const Shared& shared)
            : s(shared), dwi_vox(s.dwi), tod_vox(*(s.tod)), fiso_vox(*(s.fiso)), eext_vox(*(s.eext)),
              T(s.dwi), beta(0.1)
          {
            resetEnergy();
          }
