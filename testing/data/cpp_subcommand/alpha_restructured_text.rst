.. _testing_cpp_subcommand_alpha:

testing_cpp_subcommand alpha
============================

Synopsis
--------

First sub-interface; demonstrates the require_exactly_one constraint
...
::
    ...
    testing_cpp_subcommand alpha [ options ] 


Options
-------

-  **-alpha_value spec** An option specific to the alpha sub-interface

Exactly-one options
^^^^^^^^^^^^^^^^^^^

-  **-exone_a** The first exactly-one member

-  **-exone_b** The second exactly-one member
