  ...
  */
  void run_IncludeROIVisitation() {
    ...
    //---THREE ROIS
    {
      ...
      IncludeROIVisitation visitation(unordered, ordered);
      std::array<Vector3f, 11> tck = {Vector3f(3, 0, 0),
                                      Vector3f(0, 5, 0),
                                      Vector3f(0, 0, 7),
                                      Vector3f(11, 0, 7),
    ...
    //---A->B->J->C->D->K->D->J->K->B
    {
      ...
      std::array<Vector3f, 16> tck = {
          ...
          C,
          D,
          K, // all entered once we enter K
          D, // Legal re-entry into D
          J,
          K,                  // Legal re-entry into unordered rois
      ...
      for (size_t i = 0; i < tck.size(); i++) {
        visitation(tck[i]);
        check(bool(visitation) == bool(i >= 10 && i < 14),
              "FOUR ORDERED ROIS (A-D), and Two unordered ROIs (J,K): " + str(i));
      }
    }
  }
