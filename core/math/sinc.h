...
public:
  ...
  template <class ImageType> void set(const ImageType &image, const size_t axis, const value_type position) {
  ...
  template <class Cont> value_type value(Cont &data) const {
