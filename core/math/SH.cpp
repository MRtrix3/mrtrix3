  ...
  namespace Math
  {
    namespace SH
    {
      ...
      const char* encoding_description =
        ...
        "volume 0: l = 0, m = 0 ; \n"
        "volume 1: l = 2, m = 2 (imaginary part) ; \n"
        "volume 2: l = 2, m = 1 (imaginary part) ; \n"
        "volume 3: l = 2, m = 0 ; \n"
        "volume 4: l = 2, m = 1 (real part) ; \n"
        "volume 5: l = 2, m = 2 (real part) ; \n"
        "volume 6: l = 4, m = 4 (imaginary part) ; \n"
        "volume 7: l = 4, m = 3 (imaginary part) ; \n"
        "etc...\n";
