...
.. csv-table::
    ...
    |cpp.png|, :ref:`dirvalidate`, "Validate a direction set file"
    ...
    |cpp.png|, :ref:`fixelvalidate`, "Validate the contents of a fixel directory"
    ...
    |cpp.png|, :ref:`meshvalidate`, "Validate a mesh surface file"
    ...
    |cpp.png|, :ref:`mrimpute`, "Impute predicted intensities into invalid image voxels"
    ...
    |cpp.png|, :ref:`tsfvalidate`, "Validate a track scalar file against its corresponding tractogram"
    ...
    |cpp.png|, :ref:`warpvalidate`, "Validate a non-linear warp image"
