...
- **-eddy_mask image** Provide a processing mask to use for eddy, instead of having dwifslpreproc generate one internally using dwi2mask (equivalent to including " --mask=<image>" in the contents of -eddy_options)
