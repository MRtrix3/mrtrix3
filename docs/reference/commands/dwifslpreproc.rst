...
Options for specifying the acquisition phase-encoding design
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
-  **-readout_time time** Manually specify the total readout time of the input series (in seconds) (minimum: 0.0)
...
-  **-topup_options "TopupOptions"** Manually provide additional command-line options to the topup command (provide a string within quotation marks; its contents are passed to topup verbatim)
...
-  **-eddy_options "EddyOptions"** Manually provide additional command-line options to the eddy command (provide a string within quotation marks; its contents are passed to eddy verbatim)
...
*(the options -topup_files, -se_epi are mutually exclusive; at most one may be specified)*


*(the options -topup_field, -se_epi are mutually exclusive; at most one may be specified)*


*(the options -topup_files, -align_seepi are mutually exclusive; at most one may be specified)*


*(the options -topup_field, -align_seepi are mutually exclusive; at most one may be specified)*


*(the options -topup_files, -topup_options are mutually exclusive; at most one may be specified)*


*(the options -topup_field, -topup_options are mutually exclusive; at most one may be specified)*


*(the options -eddyqc_text, -eddyqc_all are mutually exclusive; at most one may be specified)*


*(the options -rpe_none, -se_epi are mutually exclusive; at most one may be specified)*


*(the options -rpe_pair, -topup_files are mutually exclusive; at most one may be specified)*


*(the options -se_epi, -topup_files are mutually exclusive; at most one may be specified)*


*(the options -rpe_header, -pe_dir are mutually exclusive; at most one may be specified)*


*(the options -rpe_header, -readout_time are mutually exclusive; at most one may be specified)*
