...
-  **-transform mode image** transform vertices from one coordinate space to another, based on a template image; options are: fsl2real, real2fsl, voxel2real, real2voxel, freesurfer2real.
