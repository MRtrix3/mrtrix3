...
Longer discussion regarding this command can additionally be found at: https://mrtrix.readthedocs.io/en/3.0.5/concepts/afd_connectivity.html (as well as in the relevant reference).
