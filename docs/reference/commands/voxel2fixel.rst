...
::
    ...
    voxel2fixel [ options ]  image_in fixel_folder fixel_folder_out fixel_data_out

-  *image_in*: the input image.
-  *fixel_folder*: the input fixel folder. Used to define the fixels and their directions
