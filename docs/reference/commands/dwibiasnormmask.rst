...
-  **-reference value** Set the target CSF b=0 intensity in the output DWI series (minimum: 0.0; default: 1000.0)

Options relevant to the internal optimisation procedure
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

-  **-dice value** Set the Dice coefficient threshold for similarity of masks between sequential iterations that will result in termination due to convergence (range: 0.0 to 1.0; default: 0.999)
