...
::
    ...
    fixelcfestats [ options ]  in_fixel_directory subjects design connectivity out_fixel_directory
...
https://mrtrix.readthedocs.io/en/3.0.8/fixel_based_analysis/posthoc_testing.html
...
-  **-mask file** provide a fixel data file containing a mask of those fixels to contribute to processing

-  **-posthoc file** provide a fixel data file containing a mask of those fixels to contribute to statistical inference
