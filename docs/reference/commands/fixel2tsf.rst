...
-  **-angle value** the max anglular threshold for computing correspondence between a fixel direction and track tangent (range: 0.001 to 90.0; default: 45 degrees)
