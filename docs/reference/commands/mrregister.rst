...
-  **-directions spec** Specify a source of a basis direction set to be used FOD reorientation using apodised point spread functions (see Description); default: built-in 60 directions
