...
-  **-directions spec** Specify a source of a basis direction set to be used defining the number and orientation of the apodised point spread functions used in FOD reorientation (see Description); default: built-in 300-direction set
