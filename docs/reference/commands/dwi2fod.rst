...
-  **-directions spec** Specify a source of a basis direction set to be used for application of the non-negativity constraint; default: built-in 300-direction set
