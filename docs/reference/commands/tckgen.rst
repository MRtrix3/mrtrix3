...
- PTT: Parallel Transport Tractography. This probabilistic method shares concepts with the iFOD2 method, but better preserves curvature and constrains torsion between adjacent streamline segments. The required input is a Fibre Orientation Distirbution (FOD) image.
...
-  **-algorithm name** specify the tractography algorithm to use. Valid choices are: FACT, iFOD1, iFOD2, Nulldist1, Nulldist2, PTT, SD_Stream, Seedtest, Tensor_Det, Tensor_Prob (default: iFOD2).
...
* PTT: |br|
  Aydogan, D. B. & Shi, Y.Parallel Transport Tractography. IEEE Transactions on Medical Imaging, 2021, 40(2), 635-647
