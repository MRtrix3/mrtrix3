...
+--------------+---------------------------------------------------------------+
| Float16      | 16-bit floating-point (native endian-ness)                    |
+--------------+---------------------------------------------------------------+
| Float16LE    | 16-bit floating-point (little-endian)                         |
+--------------+---------------------------------------------------------------+
| Float16BE    | 16-bit floating-point (big-endian)                            |
+--------------+---------------------------------------------------------------+
...
This legacy format is no longer supported.

.. NOTE::
  Streamline (tractogram) data and their associated sidecar data are described
  separately in :ref:`tractography_data`; other filesystem data forms with which
  *MRtrix3* interacts (numerical text tables, ``.npy`` arrays, and similar) are
  described in :ref:`other_data`.
