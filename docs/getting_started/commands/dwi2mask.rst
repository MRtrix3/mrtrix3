...
-  *image*: the input DWI image containing volumes that are both
...
Generates an whole brain mask from a DWI image.All diffusion weighted
and b=0 volumes are used to obtain a mask that includes both brain
tissue and CSF.
