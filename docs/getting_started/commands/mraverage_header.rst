...
::
    ...
    mraverage_header [ options ]  input [ input ... ] output
...
-  **-padding value**  template boundary box padding in voxels.
   Default: 0

-  **-template_res value**  subsampling of template compared to
   smallest voxel size in any input image. Default: 0.90000000000000002
