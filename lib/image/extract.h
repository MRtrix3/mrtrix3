...
#ifndef __image_extract_h__
#define __image_extract_h__
  ...
  namespace Image
  {
    ...
    template <class Set> class Extract
    {
      public:
        ...
        Position<Extract<Set> > operator[] (size_t axis) {
          return (Position<Extract<Set> > (*this, axis));
        }
        Value<Extract<Set> > value () {
          return (Value<Extract<Set> > (*this));
        }
