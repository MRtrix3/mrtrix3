...
namespace MR
{
  namespace Image
  {
    namespace Filter
    {
      ...
      class Median3DFilter : public Base
      {

      public:
          template <class InputSet> Median3DFilter (InputSet& DataSet) :
            Base (DataSet),
            extent_(1) {
            extent_[0] = 3;
          }
          ...
          template <class InputSet, class OutputSet>
            ...
            Image::Kernel::run (output, input, MedianFunctor<float>(extent_), "median filtering...");
          }
