...
namespace MR
{
  namespace Image
  {
    namespace Handler
    {
      ...
      // * The data are either after the image data within the same file if extension is .msif, or
      //     in a separate file with the .sdat extension if the image extension if .msih
