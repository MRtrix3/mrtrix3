    ...
    template <class Set>
      class Subset 
      {
        ...
        public:
          ...
          int     dim (size_t axis) const { return (axes[axis].dim); }
        ...
        private:
          ...
          ssize_t get_pos (size_t axis) const { return (D[axis]-axes[axis].from); }
          void set_pos (size_t axis, ssize_t position) const { D[axis] = position + axes[axis].from; }
