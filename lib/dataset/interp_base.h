...
namespace MR {
  namespace DataSet {
     ...
     * original template DataSet class.
    ...
    template <class Set> class InterpBase {
      public:

        //! construct an InterpBase object to obtain interpolated values using the
        // parent DataSet class 
        InterpBase (Set& parent) : data (parent), out_of_bounds (true) { 
