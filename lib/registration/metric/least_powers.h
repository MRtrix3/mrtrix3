...
#ifndef __registration_metric_least_powers_h__
#define __registration_metric_least_powers_h__
        ...
        public:
          template <class Params>
            default_type operator() (Params& params,
              ...
              const default_type diff = (default_type) im1_value - (default_type) im2_value;

              const  Eigen::Vector3d g = sgn(diff) * std::pow(std::abs(diff), power - 1.0) * (im1_grad + im2_grad);
