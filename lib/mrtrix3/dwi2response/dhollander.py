...
def usage(base_parser, subparsers): #pylint: disable=unused-variable
  ...
  parser.add_argument('input', type=app.Parser.TypeInputImage(), help='Input DWI dataset')
  parser.add_argument('out_sfwm', type=app.Parser.TypeOutputFile(), help='Output single-fibre WM response function text file')
  parser.add_argument('out_gm', type=app.Parser.TypeOutputImage(), help='Output GM response function text file')
  parser.add_argument('out_csf', type=app.Parser.TypeOutputImage(), help='Output CSF response function text file')
