...
def execute(): #pylint: disable=unused-variable
  ...
  if app.ARGS.wm_algo:
    ...
    run.command('dwi2response ' + app.ARGS.wm_algo + ' dwi.mif _respsfwmss.txt -mask refined_wm.mif -number ' + str(voxsfwmcount) + ' -iter_voxels ' + str(10*voxsfwmcount) + ' -voxels voxels_sfwm.mif -scratch ' + path.quote(app.SCRATCH_DIR) + recursive_cleanup_option, show=False)
  else:
