...
def usage(base_parser, subparsers): #pylint: disable=unused-variable
  ...
  parser.add_argument('in_5tt', type=app.Parser.TypeInputImage(), help='Input co-registered 5TT image')
  parser.add_argument('out_wm', type=app.Parser.TypeOutputFile(), help='Output WM response text file')
  parser.add_argument('out_gm', type=app.Parser.TypeOutputFile(), help='Output GM response text file')
  parser.add_argument('out_csf', type=app.Parser.TypeOutputFile(), help='Output CSF response text file')
