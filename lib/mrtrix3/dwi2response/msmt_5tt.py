...
def usage(base_parser, subparsers): #pylint: disable=unused-variable
  ...
  parser.add_argument('out_wm', type=app.Parser.FileOut(), help='Output WM response text file')
  ...
  options.add_argument('-fa', type=app.Parser.Float(0.0, 1.0), metavar='value', default=0.2, help='Upper fractional anisotropy threshold for GM and CSF voxel selection (default: 0.2)')
  options.add_argument('-pvf', type=app.Parser.Float(0.0, 1.0), metavar='fraction', default=0.95, help='Partial volume fraction threshold for tissue voxel selection (default: 0.95)')
  ...
  options.add_argument('-sfwm_fa_threshold', type=app.Parser.Float(0.0, 1.0), metavar='value', help='Sets -wm_algo to fa and allows to specify a hard FA threshold for single-fibre WM voxels, which is passed to the -threshold option of the fa algorithm (warning: overrides -wm_algo option)')
