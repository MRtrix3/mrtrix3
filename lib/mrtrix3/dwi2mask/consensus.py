...
def usage(base_parser, subparsers): #pylint: disable=unused-variable
  ...
  options.add_argument('-masks', type=app.Parser.TypeOutputImage(), help='Export a 4D image containing the individual algorithm masks')
  options.add_argument('-template', type=app.Parser.TypeInputImage(), metavar=('TemplateImage', 'MaskImage'), nargs=2, help='Provide a template image and corresponding mask for those algorithms requiring such')
