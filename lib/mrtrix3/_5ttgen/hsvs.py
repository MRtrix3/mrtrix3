...
def usage(base_parser, subparsers): #pylint: disable=unused-variable
  ...
  parser.add_argument('input', type=app.Parser.TypeInputDirectory(), help='The input FreeSurfer subject directory')
  parser.add_argument('output', type=app.Parser.TypeOutputImage(), help='The output 5TT image')
  parser.add_argument('-template', type=app.Parser.TypeInputImage(), help='Provide an image that will form the template for the generated 5TT image')
