...
def usage(base_parser, subparsers): #pylint: disable=unused-variable
  ...
  parser.add_argument('input', type=app.Parser.ImageIn(), help='The input FreeSurfer parcellation image (any image containing \'aseg\' in its name)')
  ...
  options.add_argument('-lut', type=app.Parser.FileIn(), metavar='file', help='Manually provide path to the lookup table on which the input parcellation image is based (e.g. FreeSurferColorLUT.txt)')
