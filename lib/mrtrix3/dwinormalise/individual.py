...
def usage(base_parser, subparsers): #pylint: disable=unused-variable
  ...
  parser.add_argument('input_dwi', type=app.Parser.TypeInputImage(), help='The input DWI series')
  parser.add_argument('input_mask', type=app.Parser.TypeInputImage(), help='The mask within which a reference b=0 intensity will be sampled')
  parser.add_argument('output_dwi', type=app.Parser.TypeOutputImage(), help='The output intensity-normalised DWI series')
