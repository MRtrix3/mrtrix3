...
def usage(base_parser, subparsers): #pylint: disable=unused-variable
  ...
  parser.add_argument('input_dir', type=app.Parser.DirectoryIn(), help='The input directory containing all DWI images')
  parser.add_argument('mask_dir', type=app.Parser.DirectoryIn(), help='Input directory containing brain masks, corresponding to one per input image (with the same file name prefix)')
