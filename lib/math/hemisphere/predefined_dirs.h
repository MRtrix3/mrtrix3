...
{
  dirs = Math::Matrix<T> (const_cast<float*> (directions_60_data), 60, 2);
  return dirs;
}
...
{
  dirs = Math::Matrix<T> (const_cast<float*> (directions_129_data), 129, 2);
  return dirs;
}
...
{
  dirs = Math::Matrix<T> (const_cast<float*> (directions_300_data), 300, 2);
  return dirs;
}
...
{
  dirs = Math::Matrix<T> (const_cast<float*> (directions_321_data), 321, 2);
  return dirs;
}
...
{
  dirs = Math::Matrix<T> (const_cast<float*> (directions_469_data), 469, 2);
  return dirs;
}
...
{
  dirs = Math::Matrix<T> (const_cast<float*> (directions_513_data), 513, 2);
  return dirs;
}
...
{
  dirs = Math::Matrix<T> (const_cast<float*> (directions_1281_data), 1281, 2);
  return dirs;
}
