...
public:
  ...
  void set_snap_to_image(bool onoff) {
    snap_to_image_axes_and_voxel = onoff;
    snap_to_image_action->setChecked(onoff);
    emit focusChanged();
  }
  ...
  void captureGL(const std::filesystem::path &filepath) {
    const QImage image(glarea->grabFramebuffer());
...
private:
  ...
  QActionGroup *mode_group, *tool_group, *image_group, *mode_action_group, *plane_group;

  QAction *save_action, *close_action, *properties_action,

      **tool_actions, *invert_scale_action, *extra_controls_action, *snap_to_image_action, *image_hide_action,
      *next_image_action, *prev_image_action, *next_image_volume_action, *prev_image_volume_action,
      *goto_image_volume_action, *next_slice_action, *prev_slice_action, *reset_view_action,
      *next_image_volume_group_action, *prev_image_volume_group_action, *goto_image_volume_group_action,
      *wrap_volumes_action, *image_list_area,

      *reset_windowing_action, *axial_action, *sagittal_action, *coronal_action,

      *toggle_annotations_action, *show_comments_action, *show_voxel_info_action, *show_orientation_labels_action,
      *show_crosshairs_action, *show_colourbar_action, *image_interpolate_action, *full_screen_action,
