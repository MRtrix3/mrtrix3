...
void ColourMapButton::show_colour_bar_slot(bool visible) { observer.toggle_show_colour_bar(visible, *this); }

void ColourMapButton::invert_colourmap_slot(bool inverted) { observer.toggle_invert_colourmap(inverted, *this); }
