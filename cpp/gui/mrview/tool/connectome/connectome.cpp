...
Connectome::Connectome(Dock *parent)
  ...
  connect(node_visibility_matrix_operator_combobox,
          SIGNAL(activated(int)),
          this,
          SLOT(node_visibility_matrix_operator_slot(int)));
  ...
  node_visibility_warning_icon->setToolTip(
      "Changes to node visualisation will have no apparent effect if node visibility is set to \'none\'");
  ...
  connect(node_visibility_threshold_invert_checkbox,
          SIGNAL(stateChanged(int)),
          this,
          SLOT(node_visibility_parameter_slot()));
  ...
  node_geometry_overlay_3D_warning_icon->setPixmap(
      warning_icon.pixmap(node_geometry_combobox->height(), Qt::KeepAspectRatio));
  node_geometry_overlay_3D_warning_icon->setScaledContents(true);
  node_geometry_overlay_3D_warning_icon->setToolTip(
      "The node overlay image can only be displayed in pure 2D mode (slab thickness of zero)");
  ...
  node_colour_matrix_operator_combobox->setToolTip(
      tr("If node colours are determined from a matrix file, and multiple\n"
  ...
  connect(
      node_colour_matrix_operator_combobox, SIGNAL(activated(int)), this, SLOT(node_colour_matrix_operator_slot(int)));
  ...
  connect(
      node_alpha_matrix_operator_combobox, SIGNAL(activated(int)), this, SLOT(node_alpha_matrix_operator_slot(int)));
  ...
  edge_visibility_warning_icon->setToolTip(
      "Changes to edge visualisation will have no apparent effect if edge visibility is set to \'none\'");
  ...
  connect(edge_visibility_threshold_invert_checkbox,
          SIGNAL(stateChanged(int)),
          this,
          SLOT(edge_visibility_parameter_slot()));
  ...
  edge_visibility_by_nodes_checkbox->setToolTip(
      tr("Toggle whether or not an edge that connects to an invisible node (whether hidden through \"visibility\" or "
         "\"opacity\" features) should also be made invisible"));
  ...
  node_list->setFeatures(QDockWidget::DockWidgetClosable | QDockWidget::DockWidgetMovable |
...
size_t Connectome::visible_number_colourbars() {
  if (!buffer)
    return 0;
  return (((((node_colour == node_colour_t::CONNECTOME && matrix_list_model->rowCount()) ||
             node_colour == node_colour_t::VECTOR_FILE || node_colour == node_colour_t::MATRIX_FILE) &&
            show_node_colour_bar)
               ? 1
               : 0) +
          ((((edge_colour == edge_colour_t::CONNECTOME && matrix_list_model->rowCount()) ||
             edge_colour == edge_colour_t::MATRIX_FILE) &&
            show_edge_colour_bar)
               ? 1
               : 0));
...
void Connectome::connectome_selection_changed_slot(const QItemSelection &, const QItemSelection &) {
  ...
  if (edge_visibility == edge_visibility_t::CONNECTOME ||
      ((node_visibility == node_visibility_t::CONNECTOME || node_alpha == node_alpha_t::CONNECTOME) &&
       edge_visibility_by_nodes_checkbox->isChecked()))
...
void Connectome::node_visibility_selection_slot(int index) {
  ...
  case 3:
    ...
    if (selected_node_count >= 2) {
      ...
      case node_visibility_matrix_operator_t::ANY:
        node_visibility_matrix_operator_combobox->setCurrentIndex(0);
        break;
      case node_visibility_matrix_operator_t::ALL:
        node_visibility_matrix_operator_combobox->setCurrentIndex(1);
        break;
      }
  ...
  case 4:
    if (!import_vector_file(node_values_from_file_visibility, "node visibility")) {
      ...
      case node_visibility_t::ALL:
        node_visibility_combobox->setCurrentIndex(0);
        return;
      case node_visibility_t::NONE:
        node_visibility_combobox->setCurrentIndex(1);
        return;
      case node_visibility_t::DEGREE:
        node_visibility_combobox->setCurrentIndex(2);
        return;
      case node_visibility_t::CONNECTOME:
    ...
    node_visibility_matrix_operator_combobox->setVisible(false);
    node_visibility_threshold_controls->setVisible(true);
    update_controls_node_visibility(node_values_from_file_visibility.get_min(),
...
void Connectome::node_colour_selection_slot(int index) {
  ...
  case 1:
    ...
    break;
  case 2:
    if (node_colour == node_colour_t::FROM_LUT)
      return;
  ...
  case 3:
    ...
    if (selected_node_count >= 2) {
      ...
      case node_property_matrix_operator_t::MIN:
        node_colour_matrix_operator_combobox->setCurrentIndex(0);
        break;
      case node_property_matrix_operator_t::MEAN:
        node_colour_matrix_operator_combobox->setCurrentIndex(1);
        break;
      case node_property_matrix_operator_t::SUM:
        node_colour_matrix_operator_combobox->setCurrentIndex(2);
        break;
      case node_property_matrix_operator_t::MAX:
        node_colour_matrix_operator_combobox->setCurrentIndex(3);
        break;
      }
  ...
  case 4:
    if (!import_vector_file(node_values_from_file_colour, "node colours")) {
      switch (node_colour) {
      case node_colour_t::FIXED:
        node_colour_combobox->setCurrentIndex(0);
        return;
      case node_colour_t::RANDOM:
        node_colour_combobox->setCurrentIndex(1);
        return;
      case node_colour_t::FROM_LUT:
        node_colour_combobox->setCurrentIndex(2);
        return;
      case node_colour_t::CONNECTOME:
    ...
    node_colour_matrix_operator_combobox->setVisible(false);
    node_colour_range_controls->setVisible(true);
    update_controls_node_colour(node_values_from_file_colour.get_min(),
...
void Connectome::node_size_selection_slot(int index) {
  ...
  case 2:
    ...
    if (selected_node_count >= 2) {
      ...
      case node_property_matrix_operator_t::MIN:
        node_size_matrix_operator_combobox->setCurrentIndex(0);
        break;
      case node_property_matrix_operator_t::MEAN:
        node_size_matrix_operator_combobox->setCurrentIndex(1);
        break;
      case node_property_matrix_operator_t::SUM:
        node_size_matrix_operator_combobox->setCurrentIndex(2);
        break;
      case node_property_matrix_operator_t::MAX:
        node_size_matrix_operator_combobox->setCurrentIndex(3);
        break;
      }
  ...
  case 3:
    if (!import_vector_file(node_values_from_file_size, "node size")) {
      switch (node_size) {
      case node_size_t::FIXED:
        node_size_combobox->setCurrentIndex(0);
        return;
      case node_size_t::NODE_VOLUME:
        node_size_combobox->setCurrentIndex(1);
        return;
      case node_size_t::CONNECTOME:
    ...
    node_size_matrix_operator_combobox->setVisible(false);
    node_size_range_controls->setVisible(true);
    update_controls_node_size(node_values_from_file_size.get_min(),
                              node_values_from_file_size.get_mean(),
...
void Connectome::node_alpha_selection_slot(int index) {
  ...
  case 1:
    ...
    if (selected_node_count >= 2) {
      ...
      case node_property_matrix_operator_t::MIN:
        node_alpha_matrix_operator_combobox->setCurrentIndex(0);
        break;
      case node_property_matrix_operator_t::MEAN:
        node_alpha_matrix_operator_combobox->setCurrentIndex(1);
        break;
      case node_property_matrix_operator_t::SUM:
        node_alpha_matrix_operator_combobox->setCurrentIndex(2);
        break;
      case node_property_matrix_operator_t::MAX:
        node_alpha_matrix_operator_combobox->setCurrentIndex(3);
        break;
      }
    ...
    break;
  case 2:
    if (node_alpha == node_alpha_t::FROM_LUT)
      return;
  ...
  case 3:
    if (!import_vector_file(node_values_from_file_alpha, "node opacity")) {
      switch (node_alpha) {
      case node_alpha_t::FIXED:
        node_alpha_combobox->setCurrentIndex(0);
        return;
      case node_alpha_t::CONNECTOME:
        node_alpha_combobox->setCurrentIndex(1);
        return;
      case node_alpha_t::FROM_LUT:
    ...
    node_alpha_matrix_operator_combobox->setVisible(false);
    node_alpha_range_controls->setVisible(true);
    update_controls_node_alpha(node_values_from_file_alpha.get_min(),
                               node_values_from_file_alpha.get_mean(),
...
void Connectome::node_visibility_matrix_operator_slot(int value) {
  ...
  case 0:
    ...
    break;
  case 1:
    node_visibility_matrix_operator = node_visibility_matrix_operator_t::ALL;
    break;
  default:
    assert(0);
    break;
...
void Connectome::node_colour_matrix_operator_slot(int value) {
  switch (value) {
  case 0:
    node_colour_matrix_operator = node_property_matrix_operator_t::MIN;
    break;
  case 1:
    node_colour_matrix_operator = node_property_matrix_operator_t::MEAN;
    break;
  case 2:
    node_colour_matrix_operator = node_property_matrix_operator_t::SUM;
    break;
  case 3:
    node_colour_matrix_operator = node_property_matrix_operator_t::MAX;
    break;
  default:
    assert(0);
    break;
...
void Connectome::node_size_matrix_operator_slot(int value) {
  switch (value) {
  case 0:
    node_size_matrix_operator = node_property_matrix_operator_t::MIN;
    break;
  case 1:
    node_size_matrix_operator = node_property_matrix_operator_t::MEAN;
    break;
  case 2:
    node_size_matrix_operator = node_property_matrix_operator_t::SUM;
    break;
  case 3:
    node_size_matrix_operator = node_property_matrix_operator_t::MAX;
    break;
  default:
    assert(0);
    break;
...
void Connectome::node_alpha_matrix_operator_slot(int value) {
  switch (value) {
  case 0:
    node_alpha_matrix_operator = node_property_matrix_operator_t::MIN;
    break;
  case 1:
    node_alpha_matrix_operator = node_property_matrix_operator_t::MEAN;
    break;
  case 2:
    node_alpha_matrix_operator = node_property_matrix_operator_t::SUM;
    break;
  case 3:
    node_alpha_matrix_operator = node_property_matrix_operator_t::MAX;
    break;
  default:
    assert(0);
    break;
...
void Connectome::edge_visibility_selection_slot(int index) {
  ...
  case 3:
    if (!import_matrix_file(edge_values_from_file_visibility, "edge visibility")) {
      ...
      case edge_visibility_t::ALL:
        edge_visibility_combobox->setCurrentIndex(0);
        return;
      case edge_visibility_t::NONE:
        edge_visibility_combobox->setCurrentIndex(1);
        return;
      case edge_visibility_t::CONNECTOME:
        edge_visibility_combobox->setCurrentIndex(2);
        return;
      case edge_visibility_t::MATRIX_FILE:
    ...
    edge_visibility_combobox->setCurrentIndex(4);
    edge_visibility_threshold_controls->setVisible(true);
    update_controls_edge_visibility(edge_values_from_file_visibility.get_min(),
...
void Connectome::edge_geometry_selection_slot(int index) {
  ...
  switch (index) {
  case 0:
    if (edge_geometry == edge_geometry_t::LINE)
      return;
    edge_geometry = edge_geometry_t::LINE;
    edge_geometry_cylinder_lod_label->setVisible(false);
    edge_geometry_cylinder_lod_spinbox->setVisible(false);
...
void Connectome::edge_colour_selection_slot(int index) {
  ...
  case 0:
    ...
    break;
  case 1:
    if (edge_colour == edge_colour_t::DIRECTION)
      return;
  ...
  case 3:
    if (!import_matrix_file(edge_values_from_file_colour, "edge colours")) {
      switch (edge_colour) {
      case edge_colour_t::FIXED:
        edge_colour_combobox->setCurrentIndex(0);
        return;
      case edge_colour_t::DIRECTION:
        edge_colour_combobox->setCurrentIndex(1);
        return;
      case edge_colour_t::CONNECTOME:
        edge_colour_combobox->setCurrentIndex(2);
        return;
      case edge_colour_t::MATRIX_FILE:
    ...
    edge_colour_combobox->setCurrentIndex(4);
    edge_colour_range_controls->setVisible(true);
    update_controls_edge_colour(edge_values_from_file_colour.get_min(),
...
void Connectome::edge_size_selection_slot(int index) {
  ...
  case 2:
    if (!import_matrix_file(edge_values_from_file_size, "edge size")) {
      switch (edge_size) {
      case edge_size_t::FIXED:
        edge_size_combobox->setCurrentIndex(0);
        return;
      case edge_size_t::CONNECTOME:
        edge_size_combobox->setCurrentIndex(1);
        return;
      case edge_size_t::MATRIX_FILE:
    ...
    edge_size_combobox->setCurrentIndex(3);
    edge_size_range_controls->setVisible(true);
    update_controls_edge_size(edge_values_from_file_size.get_min(),
...
void Connectome::edge_alpha_selection_slot(int index) {
  ...
  case 2:
    if (!import_matrix_file(edge_values_from_file_alpha, "edge opacity")) {
      switch (edge_alpha) {
      case edge_alpha_t::FIXED:
        edge_alpha_combobox->setCurrentIndex(0);
        return;
      case edge_alpha_t::CONNECTOME:
        edge_alpha_combobox->setCurrentIndex(1);
        return;
      case edge_alpha_t::MATRIX_FILE:
    ...
    edge_alpha_combobox->setCurrentIndex(3);
    edge_alpha_range_controls->setVisible(true);
    update_controls_edge_alpha(edge_values_from_file_alpha.get_min(),
                               edge_values_from_file_alpha.get_mean(),
...
void Connectome::lut_open_slot() {
  const std::filesystem::path path = Dialog::File::get_file(this, std::string("Select lookup table file"));
  if (path.empty())
    return;
  if (!lut.empty()) {
    lut.clear();
  ...
  try {
    lut.load(path);
    lut_button->setText(QString::fromStdString(path.filename()));
  } catch (Exception &e) {
    e.display();
    return;
  }
...
void Connectome::show_node_list_slot() { node_list->show(); }
void Connectome::node_selection_settings_changed_slot() { window().updateGL(); }
...
void Connectome::clear_all() {
  ...
  selected_node_count = 0;
  if (node_visibility == node_visibility_t::CONNECTOME || node_visibility == node_visibility_t::VECTOR_FILE ||
      node_visibility == node_visibility_t::MATRIX_FILE) {
    node_visibility_combobox->removeItem(6);
    node_visibility_combobox->setCurrentIndex(0);
    node_visibility = node_visibility_t::ALL;
  }
  if (node_colour == node_colour_t::CONNECTOME || node_colour == node_colour_t::VECTOR_FILE ||
      node_colour == node_colour_t::MATRIX_FILE) {
    node_colour_combobox->removeItem(6);
    node_colour_combobox->setCurrentIndex(0);
    node_colour = node_colour_t::FIXED;
  }
  if (node_size == node_size_t::CONNECTOME || node_size == node_size_t::VECTOR_FILE ||
      node_size == node_size_t::MATRIX_FILE) {
    node_size_combobox->removeItem(5);
    node_size_combobox->setCurrentIndex(0);
    node_size = node_size_t::FIXED;
  }
  if (node_alpha == node_alpha_t::CONNECTOME || node_alpha == node_alpha_t::VECTOR_FILE ||
      node_alpha == node_alpha_t::MATRIX_FILE) {
    node_alpha_combobox->removeItem(5);
    node_alpha_combobox->setCurrentIndex(0);
    node_alpha = node_alpha_t::FIXED;
      ...
      if (node_index) {
        ...
        if (node_index >= max_index) {
          ...
          node_lower_corners.resize(
              node_index + 1,
              Eigen::Array3i{static_cast<int>(H.size(0)), static_cast<int>(H.size(1)), static_cast<int>(H.size(2))});
          node_upper_corners.resize(node_index + 1, Eigen::Array3i{-1, -1, -1});
          max_index = node_index;
        }

        const Eigen::Vector3f voxel{static_cast<float>(buffer->index(0)),
                                    static_cast<float>(buffer->index(1)),
                                    static_cast<float>(buffer->index(2))};
        node_coms[node_index] += transform.voxel2scanner.cast<float>() * voxel;
        node_volumes[node_index]++;

        for (size_t axis = 0; axis != 3; ++axis) {
          node_lower_corners[node_index][axis] =
              std::min(node_lower_corners[node_index][axis], static_cast<int>(voxel[axis]));
          node_upper_corners[node_index][axis] =
              std::max(node_upper_corners[node_index][axis], static_cast<int>(voxel[axis]));
        }
      }
    }
  }
  ...
  for (size_t i = 0; i < list.size(); ++i) {
    try {
      ...
      if (matrix.rows() != num_nodes())
        throw Exception("Matrix file \"" + std::filesystem::path(list[i]).filename().string() + "\" is incorrect size");
      FileDataVector temp;
...
void Connectome::draw_edges(const Projection &projection) {
  ...
  if (edge_visibility != edge_visibility_t::NONE) {
    ...
    if ((edge_colour == edge_colour_t::CONNECTOME || edge_colour == edge_colour_t::MATRIX_FILE) &&
        ColourMap::maps[edge_colourmap_index].is_colour)
...
bool Connectome::import_vector_file(FileDataVector &data, std::string_view attribute) {
  const std::filesystem::path path = Dialog::File::get_file(
...
bool Connectome::import_matrix_file(FileDataVector &data, std::string_view &attribute) {
  ...
  try {
    ...
    if (temp.rows() != num_nodes())
      throw Exception("Matrix file \"" + path.filename().string() + "\" is incorrect size");
  } catch (Exception &e) {
    e.display();
    return false;
  }
  ...
  if (node_visibility == node_visibility_t::ALL) {
    ...
    if (!list.empty() && selected_node_count) {
      ...
      for (node_t i = 1; i <= num_nodes(); ++i) {
        ...
        switch (node_visibility_matrix_operator) {
        case node_visibility_matrix_operator_t::ANY:
          nodes[i].set_visible(any != invert);
          break;
        case node_visibility_matrix_operator_t::ALL:
          nodes[i].set_visible(all != invert);
          break;
        }
      }
    ...
    auto functor = [&](decltype(*buffer) &in, decltype(node_overlay->data) &out) {
      ...
      if (node_index) {
        ...
        for (out.index(3) = 0; out.index(3) != 3; ++out.index(3))
          out.value() = colour[static_cast<ssize_t>(out.index(3))];
...
void Connectome::get_exemplars() {
  ...
  if (num_tracks != num_edges())
    throw Exception("Track file " + path.filename().string() + " contains " + str(num_tracks) +
...
bool Connectome::use_alpha_nodes() const {
  ...
  if (selected_node_count && (node_selection_settings.get_node_selected_alpha_multiplier() < 1.0f ||
...
bool Connectome::use_alpha_edges() const {
  ...
  if (selected_node_count && (node_selection_settings.get_edge_selected_alpha_multiplier() < 1.0f ||
