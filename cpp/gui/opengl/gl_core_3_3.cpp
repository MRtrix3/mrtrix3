...
using PFNCLEARCOLORPROC = void(CODEGEN_FUNCPTR *)(GLfloat, GLfloat, GLfloat, GLfloat);
using PFNCLEARDEPTHPROC = void(CODEGEN_FUNCPTR *)(GLdouble);
using PFNCLEARSTENCILPROC = void(CODEGEN_FUNCPTR *)(GLint);
using PFNCOLORMASKPROC = void(CODEGEN_FUNCPTR *)(GLboolean, GLboolean, GLboolean, GLboolean);
using PFNCULLFACEPROC = void(CODEGEN_FUNCPTR *)(GLenum);
using PFNDEPTHFUNCPROC = void(CODEGEN_FUNCPTR *)(GLenum);
using PFNDEPTHMASKPROC = void(CODEGEN_FUNCPTR *)(GLboolean);
using PFNDEPTHRANGEPROC = void(CODEGEN_FUNCPTR *)(GLdouble, GLdouble);
using PFNDISABLEPROC = void(CODEGEN_FUNCPTR *)(GLenum);
using PFNDRAWBUFFERPROC = void(CODEGEN_FUNCPTR *)(GLenum);
using PFNENABLEPROC = void(CODEGEN_FUNCPTR *)(GLenum);
using PFNFINISHPROC = void(CODEGEN_FUNCPTR *)();
using PFNFLUSHPROC = void(CODEGEN_FUNCPTR *)();
using PFNFRONTFACEPROC = void(CODEGEN_FUNCPTR *)(GLenum);
using PFNGETBOOLEANVPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLboolean *);
using PFNGETDOUBLEVPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLdouble *);
using PFNGETERRORPROC = GLenum(CODEGEN_FUNCPTR *)();
using PFNGETFLOATVPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLfloat *);
using PFNGETINTEGERVPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLint *);
using PFNGETSTRINGPROC = const GLubyte *(CODEGEN_FUNCPTR *)(GLenum);
using PFNGETTEXIMAGEPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLint, GLenum, GLenum, GLvoid *);
using PFNGETTEXLEVELPARAMETERFVPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLint, GLenum, GLfloat *);
using PFNGETTEXLEVELPARAMETERIVPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLint, GLenum, GLint *);
using PFNGETTEXPARAMETERFVPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLenum, GLfloat *);
using PFNGETTEXPARAMETERIVPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLenum, GLint *);
using PFNHINTPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLenum);
using PFNISENABLEDPROC = GLboolean(CODEGEN_FUNCPTR *)(GLenum);
using PFNLINEWIDTHPROC = void(CODEGEN_FUNCPTR *)(GLfloat);
using PFNLOGICOPPROC = void(CODEGEN_FUNCPTR *)(GLenum);
using PFNPIXELSTOREFPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLfloat);
using PFNPIXELSTOREIPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLint);
using PFNPOINTSIZEPROC = void(CODEGEN_FUNCPTR *)(GLfloat);
using PFNPOLYGONMODEPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLenum);
using PFNREADBUFFERPROC = void(CODEGEN_FUNCPTR *)(GLenum);
using PFNREADPIXELSPROC = void(CODEGEN_FUNCPTR *)(GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, GLvoid *);
using PFNSCISSORPROC = void(CODEGEN_FUNCPTR *)(GLint, GLint, GLsizei, GLsizei);
using PFNSTENCILFUNCPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLint, GLuint);
using PFNSTENCILMASKPROC = void(CODEGEN_FUNCPTR *)(GLuint);
using PFNSTENCILOPPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLenum, GLenum);
using PFNTEXIMAGE1DPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLint, GLint, GLsizei, GLint, GLenum, GLenum, const GLvoid *);
using PFNTEXIMAGE2DPROC =
    void(CODEGEN_FUNCPTR *)(GLenum, GLint, GLint, GLsizei, GLsizei, GLint, GLenum, GLenum, const GLvoid *);
using PFNTEXPARAMETERFPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLenum, GLfloat);
using PFNTEXPARAMETERFVPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLenum, const GLfloat *);
...
using PFNCOPYTEXIMAGE2DPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLint, GLenum, GLint, GLint, GLsizei, GLsizei, GLint);
using PFNCOPYTEXSUBIMAGE1DPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLint, GLint, GLint, GLint, GLsizei);
using PFNCOPYTEXSUBIMAGE2DPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLint, GLint, GLint, GLint, GLint, GLsizei, GLsizei);
using PFNDELETETEXTURESPROC = void(CODEGEN_FUNCPTR *)(GLsizei, const GLuint *);
using PFNDRAWARRAYSPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLint, GLsizei);
using PFNDRAWELEMENTSPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLsizei, GLenum, const GLvoid *);
using PFNGENTEXTURESPROC = void(CODEGEN_FUNCPTR *)(GLsizei, GLuint *);
using PFNISTEXTUREPROC = GLboolean(CODEGEN_FUNCPTR *)(GLuint);
...
using PFNTEXSUBIMAGE2DPROC =
    void(CODEGEN_FUNCPTR *)(GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, const GLvoid *);
...
using PFNCOPYTEXSUBIMAGE3DPROC =
    void(CODEGEN_FUNCPTR *)(GLenum, GLint, GLint, GLint, GLint, GLint, GLint, GLsizei, GLsizei);
using PFNDRAWRANGEELEMENTSPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLuint, GLuint, GLsizei, GLenum, const GLvoid *);
using PFNTEXIMAGE3DPROC =
    void(CODEGEN_FUNCPTR *)(GLenum, GLint, GLint, GLsizei, GLsizei, GLsizei, GLint, GLenum, GLenum, const GLvoid *);
using PFNTEXSUBIMAGE3DPROC = void(CODEGEN_FUNCPTR *)(
...
using PFNCOMPRESSEDTEXIMAGE1DPROC =
    void(CODEGEN_FUNCPTR *)(GLenum, GLint, GLenum, GLsizei, GLint, GLsizei, const GLvoid *);
using PFNCOMPRESSEDTEXIMAGE2DPROC =
    void(CODEGEN_FUNCPTR *)(GLenum, GLint, GLenum, GLsizei, GLsizei, GLint, GLsizei, const GLvoid *);
using PFNCOMPRESSEDTEXIMAGE3DPROC =
    void(CODEGEN_FUNCPTR *)(GLenum, GLint, GLenum, GLsizei, GLsizei, GLsizei, GLint, GLsizei, const GLvoid *);
using PFNCOMPRESSEDTEXSUBIMAGE1DPROC =
    void(CODEGEN_FUNCPTR *)(GLenum, GLint, GLint, GLsizei, GLenum, GLsizei, const GLvoid *);
using PFNCOMPRESSEDTEXSUBIMAGE2DPROC =
    void(CODEGEN_FUNCPTR *)(GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLsizei, const GLvoid *);
using PFNCOMPRESSEDTEXSUBIMAGE3DPROC = void(CODEGEN_FUNCPTR *)(
...
using PFNMULTIDRAWELEMENTSPROC =
    void(CODEGEN_FUNCPTR *)(GLenum, const GLsizei *, GLenum, const GLvoid *const *, GLsizei);
using PFNPOINTPARAMETERFPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLfloat);
...
using PFNBUFFERDATAPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLsizeiptr, const GLvoid *, GLenum);
using PFNBUFFERSUBDATAPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLintptr, GLsizeiptr, const GLvoid *);
using PFNDELETEBUFFERSPROC = void(CODEGEN_FUNCPTR *)(GLsizei, const GLuint *);
using PFNDELETEQUERIESPROC = void(CODEGEN_FUNCPTR *)(GLsizei, const GLuint *);
using PFNENDQUERYPROC = void(CODEGEN_FUNCPTR *)(GLenum);
using PFNGENBUFFERSPROC = void(CODEGEN_FUNCPTR *)(GLsizei, GLuint *);
using PFNGENQUERIESPROC = void(CODEGEN_FUNCPTR *)(GLsizei, GLuint *);
using PFNGETBUFFERPARAMETERIVPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLenum, GLint *);
using PFNGETBUFFERPOINTERVPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLenum, GLvoid **);
using PFNGETBUFFERSUBDATAPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLintptr, GLsizeiptr, GLvoid *);
using PFNGETQUERYOBJECTIVPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLenum, GLint *);
using PFNGETQUERYOBJECTUIVPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLenum, GLuint *);
using PFNGETQUERYIVPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLenum, GLint *);
using PFNISBUFFERPROC = GLboolean(CODEGEN_FUNCPTR *)(GLuint);
...
using PFNBLENDEQUATIONSEPARATEPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLenum);
using PFNCOMPILESHADERPROC = void(CODEGEN_FUNCPTR *)(GLuint);
using PFNCREATEPROGRAMPROC = GLuint(CODEGEN_FUNCPTR *)();
using PFNCREATESHADERPROC = GLuint(CODEGEN_FUNCPTR *)(GLenum);
using PFNDELETEPROGRAMPROC = void(CODEGEN_FUNCPTR *)(GLuint);
using PFNDELETESHADERPROC = void(CODEGEN_FUNCPTR *)(GLuint);
using PFNDETACHSHADERPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLuint);
using PFNDISABLEVERTEXATTRIBARRAYPROC = void(CODEGEN_FUNCPTR *)(GLuint);
using PFNDRAWBUFFERSPROC = void(CODEGEN_FUNCPTR *)(GLsizei, const GLenum *);
using PFNENABLEVERTEXATTRIBARRAYPROC = void(CODEGEN_FUNCPTR *)(GLuint);
using PFNGETACTIVEATTRIBPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLuint, GLsizei, GLsizei *, GLint *, GLenum *, GLchar *);
using PFNGETACTIVEUNIFORMPROC =
    void(CODEGEN_FUNCPTR *)(GLuint, GLuint, GLsizei, GLsizei *, GLint *, GLenum *, GLchar *);
using PFNGETATTACHEDSHADERSPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLsizei, GLsizei *, GLuint *);
using PFNGETATTRIBLOCATIONPROC = GLint(CODEGEN_FUNCPTR *)(GLuint, const GLchar *);
using PFNGETPROGRAMINFOLOGPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLsizei, GLsizei *, GLchar *);
using PFNGETPROGRAMIVPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLenum, GLint *);
using PFNGETSHADERINFOLOGPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLsizei, GLsizei *, GLchar *);
using PFNGETSHADERSOURCEPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLsizei, GLsizei *, GLchar *);
using PFNGETSHADERIVPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLenum, GLint *);
using PFNGETUNIFORMLOCATIONPROC = GLint(CODEGEN_FUNCPTR *)(GLuint, const GLchar *);
using PFNGETUNIFORMFVPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLint, GLfloat *);
using PFNGETUNIFORMIVPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLint, GLint *);
using PFNGETVERTEXATTRIBPOINTERVPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLenum, GLvoid **);
using PFNGETVERTEXATTRIBDVPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLenum, GLdouble *);
using PFNGETVERTEXATTRIBFVPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLenum, GLfloat *);
using PFNGETVERTEXATTRIBIVPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLenum, GLint *);
using PFNISPROGRAMPROC = GLboolean(CODEGEN_FUNCPTR *)(GLuint);
using PFNISSHADERPROC = GLboolean(CODEGEN_FUNCPTR *)(GLuint);
using PFNLINKPROGRAMPROC = void(CODEGEN_FUNCPTR *)(GLuint);
using PFNSHADERSOURCEPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLsizei, const GLchar *const *, const GLint *);
using PFNSTENCILFUNCSEPARATEPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLenum, GLint, GLuint);
using PFNSTENCILMASKSEPARATEPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLuint);
using PFNSTENCILOPSEPARATEPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLenum, GLenum, GLenum);
using PFNUNIFORM1FPROC = void(CODEGEN_FUNCPTR *)(GLint, GLfloat);
using PFNUNIFORM1FVPROC = void(CODEGEN_FUNCPTR *)(GLint, GLsizei, const GLfloat *);
using PFNUNIFORM1IPROC = void(CODEGEN_FUNCPTR *)(GLint, GLint);
using PFNUNIFORM1IVPROC = void(CODEGEN_FUNCPTR *)(GLint, GLsizei, const GLint *);
using PFNUNIFORM2FPROC = void(CODEGEN_FUNCPTR *)(GLint, GLfloat, GLfloat);
using PFNUNIFORM2FVPROC = void(CODEGEN_FUNCPTR *)(GLint, GLsizei, const GLfloat *);
using PFNUNIFORM2IPROC = void(CODEGEN_FUNCPTR *)(GLint, GLint, GLint);
using PFNUNIFORM2IVPROC = void(CODEGEN_FUNCPTR *)(GLint, GLsizei, const GLint *);
using PFNUNIFORM3FPROC = void(CODEGEN_FUNCPTR *)(GLint, GLfloat, GLfloat, GLfloat);
using PFNUNIFORM3FVPROC = void(CODEGEN_FUNCPTR *)(GLint, GLsizei, const GLfloat *);
using PFNUNIFORM3IPROC = void(CODEGEN_FUNCPTR *)(GLint, GLint, GLint, GLint);
using PFNUNIFORM3IVPROC = void(CODEGEN_FUNCPTR *)(GLint, GLsizei, const GLint *);
using PFNUNIFORM4FPROC = void(CODEGEN_FUNCPTR *)(GLint, GLfloat, GLfloat, GLfloat, GLfloat);
using PFNUNIFORM4FVPROC = void(CODEGEN_FUNCPTR *)(GLint, GLsizei, const GLfloat *);
using PFNUNIFORM4IPROC = void(CODEGEN_FUNCPTR *)(GLint, GLint, GLint, GLint, GLint);
using PFNUNIFORM4IVPROC = void(CODEGEN_FUNCPTR *)(GLint, GLsizei, const GLint *);
using PFNUNIFORMMATRIX2FVPROC = void(CODEGEN_FUNCPTR *)(GLint, GLsizei, GLboolean, const GLfloat *);
using PFNUNIFORMMATRIX3FVPROC = void(CODEGEN_FUNCPTR *)(GLint, GLsizei, GLboolean, const GLfloat *);
using PFNUNIFORMMATRIX4FVPROC = void(CODEGEN_FUNCPTR *)(GLint, GLsizei, GLboolean, const GLfloat *);
using PFNUSEPROGRAMPROC = void(CODEGEN_FUNCPTR *)(GLuint);
using PFNVALIDATEPROGRAMPROC = void(CODEGEN_FUNCPTR *)(GLuint);
using PFNVERTEXATTRIB1DPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLdouble);
using PFNVERTEXATTRIB1DVPROC = void(CODEGEN_FUNCPTR *)(GLuint, const GLdouble *);
using PFNVERTEXATTRIB1FPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLfloat);
using PFNVERTEXATTRIB1FVPROC = void(CODEGEN_FUNCPTR *)(GLuint, const GLfloat *);
using PFNVERTEXATTRIB1SPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLshort);
using PFNVERTEXATTRIB1SVPROC = void(CODEGEN_FUNCPTR *)(GLuint, const GLshort *);
using PFNVERTEXATTRIB2DPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLdouble, GLdouble);
using PFNVERTEXATTRIB2DVPROC = void(CODEGEN_FUNCPTR *)(GLuint, const GLdouble *);
using PFNVERTEXATTRIB2FPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLfloat, GLfloat);
using PFNVERTEXATTRIB2FVPROC = void(CODEGEN_FUNCPTR *)(GLuint, const GLfloat *);
using PFNVERTEXATTRIB2SPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLshort, GLshort);
using PFNVERTEXATTRIB2SVPROC = void(CODEGEN_FUNCPTR *)(GLuint, const GLshort *);
using PFNVERTEXATTRIB3DPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLdouble, GLdouble, GLdouble);
using PFNVERTEXATTRIB3DVPROC = void(CODEGEN_FUNCPTR *)(GLuint, const GLdouble *);
using PFNVERTEXATTRIB3FPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLfloat, GLfloat, GLfloat);
using PFNVERTEXATTRIB3FVPROC = void(CODEGEN_FUNCPTR *)(GLuint, const GLfloat *);
using PFNVERTEXATTRIB3SPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLshort, GLshort, GLshort);
using PFNVERTEXATTRIB3SVPROC = void(CODEGEN_FUNCPTR *)(GLuint, const GLshort *);
using PFNVERTEXATTRIB4NBVPROC = void(CODEGEN_FUNCPTR *)(GLuint, const GLbyte *);
using PFNVERTEXATTRIB4NIVPROC = void(CODEGEN_FUNCPTR *)(GLuint, const GLint *);
using PFNVERTEXATTRIB4NSVPROC = void(CODEGEN_FUNCPTR *)(GLuint, const GLshort *);
using PFNVERTEXATTRIB4NUBPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLubyte, GLubyte, GLubyte, GLubyte);
using PFNVERTEXATTRIB4NUBVPROC = void(CODEGEN_FUNCPTR *)(GLuint, const GLubyte *);
using PFNVERTEXATTRIB4NUIVPROC = void(CODEGEN_FUNCPTR *)(GLuint, const GLuint *);
using PFNVERTEXATTRIB4NUSVPROC = void(CODEGEN_FUNCPTR *)(GLuint, const GLushort *);
using PFNVERTEXATTRIB4BVPROC = void(CODEGEN_FUNCPTR *)(GLuint, const GLbyte *);
using PFNVERTEXATTRIB4DPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLdouble, GLdouble, GLdouble, GLdouble);
using PFNVERTEXATTRIB4DVPROC = void(CODEGEN_FUNCPTR *)(GLuint, const GLdouble *);
using PFNVERTEXATTRIB4FPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLfloat, GLfloat, GLfloat, GLfloat);
using PFNVERTEXATTRIB4FVPROC = void(CODEGEN_FUNCPTR *)(GLuint, const GLfloat *);
using PFNVERTEXATTRIB4IVPROC = void(CODEGEN_FUNCPTR *)(GLuint, const GLint *);
using PFNVERTEXATTRIB4SPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLshort, GLshort, GLshort, GLshort);
using PFNVERTEXATTRIB4SVPROC = void(CODEGEN_FUNCPTR *)(GLuint, const GLshort *);
using PFNVERTEXATTRIB4UBVPROC = void(CODEGEN_FUNCPTR *)(GLuint, const GLubyte *);
...
using PFNUNIFORMMATRIX3X2FVPROC = void(CODEGEN_FUNCPTR *)(GLint, GLsizei, GLboolean, const GLfloat *);
...
using PFNBINDBUFFERBASEPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLuint, GLuint);
using PFNBINDBUFFERRANGEPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLuint, GLuint, GLintptr, GLsizeiptr);
using PFNBINDFRAGDATALOCATIONPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLuint, const GLchar *);
using PFNBINDFRAMEBUFFERPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLuint);
using PFNBINDRENDERBUFFERPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLuint);
using PFNBINDVERTEXARRAYPROC = void(CODEGEN_FUNCPTR *)(GLuint);
using PFNBLITFRAMEBUFFERPROC =
    void(CODEGEN_FUNCPTR *)(GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLbitfield, GLenum);
using PFNCHECKFRAMEBUFFERSTATUSPROC = GLenum(CODEGEN_FUNCPTR *)(GLenum);
using PFNCLAMPCOLORPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLenum);
using PFNCLEARBUFFERFIPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLint, GLfloat, GLint);
using PFNCLEARBUFFERFVPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLint, const GLfloat *);
using PFNCLEARBUFFERIVPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLint, const GLint *);
using PFNCLEARBUFFERUIVPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLint, const GLuint *);
using PFNCOLORMASKIPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLboolean, GLboolean, GLboolean, GLboolean);
using PFNDELETEFRAMEBUFFERSPROC = void(CODEGEN_FUNCPTR *)(GLsizei, const GLuint *);
using PFNDELETERENDERBUFFERSPROC = void(CODEGEN_FUNCPTR *)(GLsizei, const GLuint *);
using PFNDELETEVERTEXARRAYSPROC = void(CODEGEN_FUNCPTR *)(GLsizei, const GLuint *);
using PFNDISABLEIPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLuint);
using PFNENABLEIPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLuint);
using PFNENDCONDITIONALRENDERPROC = void(CODEGEN_FUNCPTR *)();
using PFNENDTRANSFORMFEEDBACKPROC = void(CODEGEN_FUNCPTR *)();
using PFNFLUSHMAPPEDBUFFERRANGEPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLintptr, GLsizeiptr);
using PFNFRAMEBUFFERRENDERBUFFERPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLenum, GLenum, GLuint);
using PFNFRAMEBUFFERTEXTURE1DPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLenum, GLenum, GLuint, GLint);
using PFNFRAMEBUFFERTEXTURE2DPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLenum, GLenum, GLuint, GLint);
using PFNFRAMEBUFFERTEXTURE3DPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLenum, GLenum, GLuint, GLint, GLint);
using PFNFRAMEBUFFERTEXTURELAYERPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLenum, GLuint, GLint, GLint);
using PFNGENFRAMEBUFFERSPROC = void(CODEGEN_FUNCPTR *)(GLsizei, GLuint *);
using PFNGENRENDERBUFFERSPROC = void(CODEGEN_FUNCPTR *)(GLsizei, GLuint *);
using PFNGENVERTEXARRAYSPROC = void(CODEGEN_FUNCPTR *)(GLsizei, GLuint *);
using PFNGENERATEMIPMAPPROC = void(CODEGEN_FUNCPTR *)(GLenum);
using PFNGETBOOLEANI_VPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLuint, GLboolean *);
using PFNGETFRAGDATALOCATIONPROC = GLint(CODEGEN_FUNCPTR *)(GLuint, const GLchar *);
using PFNGETFRAMEBUFFERATTACHMENTPARAMETERIVPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLenum, GLenum, GLint *);
using PFNGETINTEGERI_VPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLuint, GLint *);
using PFNGETRENDERBUFFERPARAMETERIVPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLenum, GLint *);
using PFNGETSTRINGIPROC = const GLubyte *(CODEGEN_FUNCPTR *)(GLenum, GLuint);
using PFNGETTEXPARAMETERIIVPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLenum, GLint *);
using PFNGETTEXPARAMETERIUIVPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLenum, GLuint *);
using PFNGETTRANSFORMFEEDBACKVARYINGPROC =
    void(CODEGEN_FUNCPTR *)(GLuint, GLuint, GLsizei, GLsizei *, GLsizei *, GLenum *, GLchar *);
using PFNGETUNIFORMUIVPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLint, GLuint *);
using PFNGETVERTEXATTRIBIIVPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLenum, GLint *);
using PFNGETVERTEXATTRIBIUIVPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLenum, GLuint *);
using PFNISENABLEDIPROC = GLboolean(CODEGEN_FUNCPTR *)(GLenum, GLuint);
using PFNISFRAMEBUFFERPROC = GLboolean(CODEGEN_FUNCPTR *)(GLuint);
using PFNISRENDERBUFFERPROC = GLboolean(CODEGEN_FUNCPTR *)(GLuint);
using PFNISVERTEXARRAYPROC = GLboolean(CODEGEN_FUNCPTR *)(GLuint);
using PFNMAPBUFFERRANGEPROC = void *(CODEGEN_FUNCPTR *)(GLenum, GLintptr, GLsizeiptr, GLbitfield);
using PFNRENDERBUFFERSTORAGEPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLenum, GLsizei, GLsizei);
using PFNRENDERBUFFERSTORAGEMULTISAMPLEPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLsizei, GLenum, GLsizei, GLsizei);
using PFNTEXPARAMETERIIVPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLenum, const GLint *);
using PFNTEXPARAMETERIUIVPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLenum, const GLuint *);
using PFNTRANSFORMFEEDBACKVARYINGSPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLsizei, const GLchar *const *, GLenum);
using PFNUNIFORM1UIPROC = void(CODEGEN_FUNCPTR *)(GLint, GLuint);
using PFNUNIFORM1UIVPROC = void(CODEGEN_FUNCPTR *)(GLint, GLsizei, const GLuint *);
using PFNUNIFORM2UIPROC = void(CODEGEN_FUNCPTR *)(GLint, GLuint, GLuint);
using PFNUNIFORM2UIVPROC = void(CODEGEN_FUNCPTR *)(GLint, GLsizei, const GLuint *);
using PFNUNIFORM3UIPROC = void(CODEGEN_FUNCPTR *)(GLint, GLuint, GLuint, GLuint);
using PFNUNIFORM3UIVPROC = void(CODEGEN_FUNCPTR *)(GLint, GLsizei, const GLuint *);
using PFNUNIFORM4UIPROC = void(CODEGEN_FUNCPTR *)(GLint, GLuint, GLuint, GLuint, GLuint);
using PFNUNIFORM4UIVPROC = void(CODEGEN_FUNCPTR *)(GLint, GLsizei, const GLuint *);
using PFNVERTEXATTRIBI1IPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLint);
using PFNVERTEXATTRIBI1IVPROC = void(CODEGEN_FUNCPTR *)(GLuint, const GLint *);
using PFNVERTEXATTRIBI1UIPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLuint);
using PFNVERTEXATTRIBI1UIVPROC = void(CODEGEN_FUNCPTR *)(GLuint, const GLuint *);
using PFNVERTEXATTRIBI2IPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLint, GLint);
using PFNVERTEXATTRIBI2IVPROC = void(CODEGEN_FUNCPTR *)(GLuint, const GLint *);
using PFNVERTEXATTRIBI2UIPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLuint, GLuint);
using PFNVERTEXATTRIBI2UIVPROC = void(CODEGEN_FUNCPTR *)(GLuint, const GLuint *);
using PFNVERTEXATTRIBI3IPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLint, GLint, GLint);
using PFNVERTEXATTRIBI3IVPROC = void(CODEGEN_FUNCPTR *)(GLuint, const GLint *);
using PFNVERTEXATTRIBI3UIPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLuint, GLuint, GLuint);
using PFNVERTEXATTRIBI3UIVPROC = void(CODEGEN_FUNCPTR *)(GLuint, const GLuint *);
using PFNVERTEXATTRIBI4BVPROC = void(CODEGEN_FUNCPTR *)(GLuint, const GLbyte *);
using PFNVERTEXATTRIBI4IPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLint, GLint, GLint, GLint);
using PFNVERTEXATTRIBI4IVPROC = void(CODEGEN_FUNCPTR *)(GLuint, const GLint *);
using PFNVERTEXATTRIBI4SVPROC = void(CODEGEN_FUNCPTR *)(GLuint, const GLshort *);
using PFNVERTEXATTRIBI4UBVPROC = void(CODEGEN_FUNCPTR *)(GLuint, const GLubyte *);
using PFNVERTEXATTRIBI4UIPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLuint, GLuint, GLuint, GLuint);
...
using PFNDRAWELEMENTSINSTANCEDPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLsizei, GLenum, const GLvoid *, GLsizei);
using PFNGETACTIVEUNIFORMBLOCKNAMEPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLuint, GLsizei, GLsizei *, GLchar *);
using PFNGETACTIVEUNIFORMBLOCKIVPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLuint, GLenum, GLint *);
using PFNGETACTIVEUNIFORMNAMEPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLuint, GLsizei, GLsizei *, GLchar *);
using PFNGETACTIVEUNIFORMSIVPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLsizei, const GLuint *, GLenum, GLint *);
using PFNGETUNIFORMBLOCKINDEXPROC = GLuint(CODEGEN_FUNCPTR *)(GLuint, const GLchar *);
using PFNGETUNIFORMINDICESPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLsizei, const GLchar *const *, GLuint *);
...
using PFNDRAWELEMENTSBASEVERTEXPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLsizei, GLenum, const GLvoid *, GLint);
using PFNDRAWELEMENTSINSTANCEDBASEVERTEXPROC =
    void(CODEGEN_FUNCPTR *)(GLenum, GLsizei, GLenum, const GLvoid *, GLsizei, GLint);
using PFNDRAWRANGEELEMENTSBASEVERTEXPROC =
    void(CODEGEN_FUNCPTR *)(GLenum, GLuint, GLuint, GLsizei, GLenum, const GLvoid *, GLint);
using PFNFENCESYNCPROC = GLsync(CODEGEN_FUNCPTR *)(GLenum, GLbitfield);
using PFNFRAMEBUFFERTEXTUREPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLenum, GLuint, GLint);
using PFNGETBUFFERPARAMETERI64VPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLenum, GLint64 *);
using PFNGETINTEGER64I_VPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLuint, GLint64 *);
using PFNGETINTEGER64VPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLint64 *);
using PFNGETMULTISAMPLEFVPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLuint, GLfloat *);
using PFNGETSYNCIVPROC = void(CODEGEN_FUNCPTR *)(GLsync, GLenum, GLsizei, GLsizei *, GLint *);
using PFNISSYNCPROC = GLboolean(CODEGEN_FUNCPTR *)(GLsync);
using PFNMULTIDRAWELEMENTSBASEVERTEXPROC =
    void(CODEGEN_FUNCPTR *)(GLenum, const GLsizei *, GLenum, const GLvoid *const *, GLsizei, const GLint *);
using PFNPROVOKINGVERTEXPROC = void(CODEGEN_FUNCPTR *)(GLenum);
using PFNSAMPLEMASKIPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLbitfield);
using PFNTEXIMAGE2DMULTISAMPLEPROC = void(CODEGEN_FUNCPTR *)(GLenum, GLsizei, GLint, GLsizei, GLsizei, GLboolean);
using PFNTEXIMAGE3DMULTISAMPLEPROC =
    void(CODEGEN_FUNCPTR *)(GLenum, GLsizei, GLint, GLsizei, GLsizei, GLsizei, GLboolean);
...
using PFNDELETESAMPLERSPROC = void(CODEGEN_FUNCPTR *)(GLsizei, const GLuint *);
using PFNGENSAMPLERSPROC = void(CODEGEN_FUNCPTR *)(GLsizei, GLuint *);
using PFNGETFRAGDATAINDEXPROC = GLint(CODEGEN_FUNCPTR *)(GLuint, const GLchar *);
using PFNGETQUERYOBJECTI64VPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLenum, GLint64 *);
using PFNGETQUERYOBJECTUI64VPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLenum, GLuint64 *);
using PFNGETSAMPLERPARAMETERIIVPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLenum, GLint *);
using PFNGETSAMPLERPARAMETERIUIVPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLenum, GLuint *);
using PFNGETSAMPLERPARAMETERFVPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLenum, GLfloat *);
using PFNGETSAMPLERPARAMETERIVPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLenum, GLint *);
using PFNISSAMPLERPROC = GLboolean(CODEGEN_FUNCPTR *)(GLuint);
using PFNQUERYCOUNTERPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLenum);
using PFNSAMPLERPARAMETERIIVPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLenum, const GLint *);
using PFNSAMPLERPARAMETERIUIVPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLenum, const GLuint *);
using PFNSAMPLERPARAMETERFPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLenum, GLfloat);
using PFNSAMPLERPARAMETERFVPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLenum, const GLfloat *);
using PFNSAMPLERPARAMETERIPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLenum, GLint);
using PFNSAMPLERPARAMETERIVPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLenum, const GLint *);
using PFNVERTEXATTRIBDIVISORPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLuint);
using PFNVERTEXATTRIBP1UIPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLenum, GLboolean, GLuint);
using PFNVERTEXATTRIBP1UIVPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLenum, GLboolean, const GLuint *);
using PFNVERTEXATTRIBP2UIPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLenum, GLboolean, GLuint);
using PFNVERTEXATTRIBP2UIVPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLenum, GLboolean, const GLuint *);
using PFNVERTEXATTRIBP3UIPROC = void(CODEGEN_FUNCPTR *)(GLuint, GLenum, GLboolean, GLuint);
...
Switch_ReadPixels(GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, GLvoid *pixels) {
...
static void CODEGEN_FUNCPTR
Switch_CopyTexSubImage1D(GLenum target, GLint level, GLint xoffset, GLint x, GLint y, GLsizei width) {
...
static void CODEGEN_FUNCPTR
Switch_DrawRangeElements(GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const GLvoid *indices) {
...
static void CODEGEN_FUNCPTR
Switch_BindBufferRange(GLenum target, GLuint index, GLuint buffer, GLintptr offset, GLsizeiptr size) {
...
static void CODEGEN_FUNCPTR
Switch_FramebufferTexture1D(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level) {
  FramebufferTexture1D = (PFNFRAMEBUFFERTEXTURE1DPROC)IntGetProcAddress("glFramebufferTexture1D");
  FramebufferTexture1D(target, attachment, textarget, texture, level);
}

static void CODEGEN_FUNCPTR
Switch_FramebufferTexture2D(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level) {
...
static void CODEGEN_FUNCPTR
Switch_FramebufferTextureLayer(GLenum target, GLenum attachment, GLuint texture, GLint level, GLint layer) {
...
static void CODEGEN_FUNCPTR Switch_GetFramebufferAttachmentParameteriv(GLenum target,
                                                                       GLenum attachment,
                                                                       GLenum pname,
                                                                       GLint *params) {
  GetFramebufferAttachmentParameteriv =
      (PFNGETFRAMEBUFFERATTACHMENTPARAMETERIVPROC)IntGetProcAddress("glGetFramebufferAttachmentParameteriv");
...
static void CODEGEN_FUNCPTR Switch_RenderbufferStorageMultisample(
  ...
  RenderbufferStorageMultisample =
      (PFNRENDERBUFFERSTORAGEMULTISAMPLEPROC)IntGetProcAddress("glRenderbufferStorageMultisample");
...
static void CODEGEN_FUNCPTR
Switch_VertexAttribIPointer(GLuint index, GLint size, GLenum type, GLsizei stride, const GLvoid *pointer) {
...
static void CODEGEN_FUNCPTR
Switch_DrawElementsInstanced(GLenum mode, GLsizei count, GLenum type, const GLvoid *indices, GLsizei instancecount) {
...
static void CODEGEN_FUNCPTR
Switch_DrawElementsBaseVertex(GLenum mode, GLsizei count, GLenum type, const GLvoid *indices, GLint basevertex) {
...
static void CODEGEN_FUNCPTR Switch_DrawElementsInstancedBaseVertex(
  ...
  DrawElementsInstancedBaseVertex =
      (PFNDRAWELEMENTSINSTANCEDBASEVERTEXPROC)IntGetProcAddress("glDrawElementsInstancedBaseVertex");
...
static void CODEGEN_FUNCPTR
Switch_GetSynciv(GLsync sync, GLenum pname, GLsizei bufSize, GLsizei *length, GLint *values) {
