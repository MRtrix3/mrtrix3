...
void usage() {
  ...
  + Option ("coord",
    ...
    + ArgumentTuple (Argument ("axis",      "the image axis along which to make the selection").type_integer (0),
  ...
  + ArgumentTuple (Argument ("key",   "the header key to set").type_text(),
  ...
  + ArgumentTuple (Argument ("key",   "the header key to append to").type_text(),
