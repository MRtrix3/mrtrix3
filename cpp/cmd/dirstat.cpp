...
void run() {
  ...
  try {
    directions = DWI::Directions::load_cartesian(dirs_input_path);
  } catch (Exception &E) {
    try {
      directions = File::Matrix::load_matrix<double>(dirs_input_path);
    } catch (Exception &E) {
      auto header = Header::open(dirs_input_path);
...
void output_selected(const Metrics &metrics, const std::string &selection) {
  ...
  for (const auto &x : select) {
    ...
    if (xl == "uet")
      std::cout << metrics.UE[0] << " ";
    else if (xl == "ue")
      std::cout << metrics.UE[1] << " ";
    else if (xl == "ue-")
      std::cout << metrics.UE[2] << " ";
    else if (xl == "ue+")
      std::cout << metrics.UE[3] << " ";
    else if (xl == "bet")
      std::cout << metrics.BE[0] << " ";
    else if (xl == "be")
      std::cout << metrics.BE[1] << " ";
    else if (xl == "be-")
      std::cout << metrics.BE[2] << " ";
    else if (xl == "be+")
      std::cout << metrics.BE[3] << " ";
    else if (xl == "un")
      std::cout << metrics.UN[0] << " ";
    else if (xl == "un-")
      std::cout << metrics.UN[1] << " ";
    else if (xl == "un+")
      std::cout << metrics.UN[2] << " ";
    else if (xl == "bn")
      std::cout << metrics.BN[0] << " ";
    else if (xl == "bn-")
      std::cout << metrics.BN[1] << " ";
    else if (xl == "bn+")
      std::cout << metrics.BN[2] << " ";
    else if (xl == "asym")
      std::cout << metrics.ASYM << " ";
    else if (xl == "n")
