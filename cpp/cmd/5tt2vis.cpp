...
void usage() {
  ...
  + Option ("bg", "image intensity of background")
    + Argument ("value").type_float (0.0, 1.0).set_default (str(default_value_background, 2))

  + Option ("cgm", "image intensity of cortical grey matter")
    + Argument ("value").type_float (0.0, 1.0).set_default (str(default_value_cgm, 2))

  + Option ("sgm", "image intensity of sub-cortical grey matter")
    + Argument ("value").type_float (0.0, 1.0).set_default (str(default_value_sgm, 2))

  + Option ("wm", "image intensity of white matter")
    + Argument ("value").type_float (0.0, 1.0).set_default (str(default_value_wm, 2))

  + Option ("csf", "image intensity of CSF")
    + Argument ("value").type_float (0.0, 1.0).set_default (str(default_value_csf, 2))

  + Option ("path", "image intensity of pathological tissue")
    + Argument ("value").type_float (0.0, 10.0).set_default (str(default_value_pathology, 2));
