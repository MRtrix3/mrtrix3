...
void usage() {
  ...
  + Option ("plane", "fill one or more planes perpendicular to the specified axis").allow_multiple()
    + ArgumentTuple (Argument ("axis",  "the axis perpendicular to the plane(s)").type_integer (0, 2),
  ...
  + Option ("sphere", "draw a sphere of the specified radius").allow_multiple()
    + ArgumentTuple (Argument ("position", "the centre of the sphere").type_sequence_float(),
  ...
  + Option ("ellipsoid", "draw an ellipsoid"
    ...
    + ArgumentTuple (Argument ("position", "the centre of the ellipsoid").type_sequence_float(),
  ...
  + Option ("cuboid", "draw a rectangular cuboid"
    ...
    + ArgumentTuple (Argument ("position", "the centre of the cuboid").type_sequence_float(),
  ...
  + Option ("line", "draw a single-voxel-thick line between two points"
    ...
    + ArgumentTuple (Argument ("first",  "the first end-point of the line").type_sequence_float(),
  ...
  + Option ("voxel", "change the image value within a single voxel").allow_multiple()
    + ArgumentTuple (Argument ("position", "the position of the voxel").type_sequence_float(),
                     Argument ("value",    "the intensity value to set").type_float())
