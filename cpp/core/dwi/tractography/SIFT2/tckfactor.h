...
public:
  ...
  void
  output_TD_images(const std::filesystem::path &, const std::filesystem::path &, const std::filesystem::path &) const;
  void output_all_debug_images(const std::filesystem::path &, const std::filesystem::path &) const;
