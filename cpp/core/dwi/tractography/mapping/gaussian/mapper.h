...
public:
  ...
  template <class Cont> bool operator()(Streamline<> &in, Cont &out) const {
    out.clear();
...
protected:
  ...
  inline void
  add_to_set(SetVoxel &, const Eigen::Vector3i &, const tangent_type &, const default_type, const default_type) const;
  inline void add_to_set(
      SetVoxelDEC &, const Eigen::Vector3i &, const tangent_type &, const default_type, const default_type) const;
  inline void
  add_to_set(SetDixel &, const Eigen::Vector3i &, const tangent_type &, const default_type, const default_type) const;
  inline void add_to_set(
      SetVoxelTOD &, const Eigen::Vector3i &, const tangent_type &, const default_type, const default_type) const;
...
template <class Cont> void TrackMapper::voxelise_precise(const Streamline<> &tck, Cont &out) const {

  using point_type = Streamline<>::point_type;
  using value_type = Streamline<>::value_type;

  static const default_type accuracy =
...
template <class Cont> void TrackMapper::voxelise_ends(const Streamline<> &tck, Cont &out) const {
...
inline void TrackMapper::add_to_set(
    SetVoxel &out, const Eigen::Vector3i &v, const tangent_type &d, const default_type l, const default_type f) const {
  out.insert(v, l, f);
}
...
inline void TrackMapper::add_to_set(
    SetDixel &out, const Eigen::Vector3i &v, const tangent_type &d, const default_type l, const default_type f) const {
  assert(dixel_plugin);
