...
public:
  ...
  bool operator()(const SetVoxel &in) override {
    receive_greyscale(in);
    return true;
  }
  bool operator()(const SetVoxelDEC &in) override {
    receive_dec(in);
    return true;
  }
  ...
  bool operator()(const SetVoxelTOD &in) override {
    receive_tod(in);
    return true;
  }

  bool operator()(const Gaussian::SetVoxel &in) override {
    receive_greyscale(in);
    return true;
  }
  ...
  bool operator()(const Gaussian::SetVoxelTOD &in) override {
    receive_tod(in);
    return true;
  }
