...
inline void save_cartesian(const MatrixType &directions, const std::filesystem::path &filename) {
...
template <class MatrixType>
inline void save_spherical(const MatrixType &directions, const std::filesystem::path &filename) {
...
template <class MatrixType>
inline void save(const MatrixType &directions, const std::filesystem::path &filename, bool cartesian) {
  if (cartesian)
