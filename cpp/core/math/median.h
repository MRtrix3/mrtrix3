...
template <class Container> inline typename Container::value_type quantile(Container &list, default_type quantile) {
...
// Weiszfeld median
template <class MatrixType = Eigen::Matrix<default_type, 3, Eigen::Dynamic>,
          class VectorType = Eigen::Matrix<default_type, 3, 1>>
bool median_weiszfeld(const MatrixType &X,
                      VectorType &median,
