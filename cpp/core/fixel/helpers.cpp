...
void check_fixel_directory(std::string_view path, bool create_if_missing, bool check_if_empty) {
...
std::vector<Header>
find_data_headers(std::string_view fixel_directory_path, const Header &index_header, const bool include_directions) {
