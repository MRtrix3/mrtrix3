...
class OpFinite : public OpUnary {
  public:
    ...
    complex_type R (real_type v) const { return isfinite (v) != 0; }
    complex_type Z (complex_type v) const { return isfinite (v.real()) != 0|| isfinite (v.imag()) != 0; }
};
