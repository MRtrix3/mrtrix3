...
void usage() {
  ...
  +"References based on streamlines algorithm used:"
      ...
      + "* -act, -backtrack, -seed_gmwmi:\n"
        ...
        "Anatomically-constrained tractography: Improved diffusion MRI streamlines tractography through effective use "
        "of anatomical information. "
        "NeuroImage, 2012, 62, 1924-1938"

      + "* -seed_dynamic:\n"
        "Smith, R. E.; Tournier, J.-D.; Calamante, F. & Connelly, A. " // Internal
        "SIFT2: Enabling dense quantitative assessment of brain white matter connectivity using streamlines "
        "tractography. "
  ...
  +Argument("source",
            ...
            "The type of image data required depends on the algorithm used (see Description section).")
          .type_image_in()
  ...
  +Option("algorithm",
      ...
      + DWI::Tractography::Algorithms::iFODOptions + DWI::Tractography::Algorithms::iFOD2Options
