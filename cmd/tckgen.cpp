...
const char* algorithms[] = { "ballsticks", "fact", "ifod1", "ifod2", "nulldist1", "nulldist2", "sd_stream", "seedtest", "tensor_det", "tensor_prob", nullptr };
...
void usage ()
{
  ...
  DESCRIPTION
    ...
    + "- BallSticks: A probabilistic streamlines algorithm that operates on data from "
      "the ball-and-sticks model; specifically, the multiple bootstrap realisations "
      "of that model that are generated by the FSL \"bedpostx\" command. "
      "While the empirical behaviour of this algorithm is intended to mimic that of the "
      "tractography algorithm implemented in the FSL \"probtrackx\" command, "
      "equivalence of the two is in no way guaranteed, and default parameters "
      "differ between the two implementations. "
      "This algorithm expects as input the path to the directory that is generated by "
      "the FSL command \"bedpostx\"."
  ...
  REFERENCES
   ...
   "Magnetic Resonance in Medicine, 2003, 50, 1077-1088 \n"
  ...
  ARGUMENTS
    + Argument ("source",
        ...
        "The type of image data required depends on the algorithm used (see Description section).").type_various()
  ...
  + Option ("algorithm",
            "specify the tractography algorithm to use. Valid choices are: "
              "BallSticks, FACT, iFOD1, iFOD2, Nulldist1, Nulldist2, SD_Stream, Seedtest, Tensor_Det, Tensor_Prob (default: iFOD2).")
  ...
  + DWI::Tractography::Algorithms::BallSticksOptions
...
void run ()
{
  ...
  if (algorithm == 0)
    Algorithms::load_ballsticks_options (properties);
  ...
  switch (algorithm) {
    case 0:
      Exec<BallSticks> ::run (argument[0], argument[1], properties);
      break;
    case 1:
