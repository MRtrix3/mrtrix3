...
const char* algorithms[] = { "fact", "ifod1", "ifod2", "new_algorithm",  "nulldist1", "nulldist2", "sd_stream", "seedtest", "tensor_det", "tensor_prob", nullptr };
...
void usage ()
{
  ...
  + "- NewAlgorithm： A copy of SD_STREAM."
  ...
  + Option ("algorithm",
            ...
            "FACT, iFOD1, iFOD2, New_Algorithm, Nulldist1, Nulldist2, SD_Stream, Seedtest, Tensor_Det, Tensor_Prob (default: iFOD2).")
...
void run ()
{
  ...
  //Sibo Xu 30/01/2023 add command line option
  if (algorithm == 3)
    Algorithms::load_new_algorithm_options (properties);
  ...
  switch (algorithm) {
    ...
    case 2:
      ...
      break;
    case 3:
      Exec<NewAlgorithm> ::run (argument[0], argument[1], properties);
      break;
    case 4:
